...
def do_build(args):
    ...
    if target_args in ('native'):
        target_arch = host_arch
                         ...
                         'ios-aarch64', 'ios-simulator-aarch64', 'ios-x86_64-simulator'):
    ...
    if target_args == "native":
    ...
    elif target_args in ["ios-aarch64", "ios-simulator-aarch64", "ios-x86_64-simulator"]:
        if args.target_toolchain == None:
        ...
        ios_simulator_flag = "1" if  target_args in ["ios-simulator-aarch64", "ios-x86_64-simulator"] else "0"
        cmake_command = [
            "cmake",
            "-DCMAKE_INSTALL_PREFIX={}_{}".format(install_prefix, target_arch),
            "-DCMAKE_BUILD_TYPE={}".format(mode),
        ...
        print("Invalid build target, build targets include: native, windows-x86_64, ohos-aarch64, ohos-x86_64, \
               ohos-arm, android-aarch64, android-x86_64, ios-aarch64, ios-simulator-aarch64, ios-x86_64-simulator")
        sys.exit(1)
...
if __name__ == "__main__":
    ...
    b.add_argument(
        "--target",
        choices=["native", "windows-x86_64", "ohos-aarch64", "ohos-x86_64", "ohos-arm", "ios-simulator-aarch64", "ios-x86_64-simulator", "ios-aarch64", "android-aarch64", "android-x86_64"],
        metavar="TARGET",
        default="native",
