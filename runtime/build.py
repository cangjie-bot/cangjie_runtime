...
def do_build(args):
    ...
    if target_args == "native":
        ...
        print("Invalid build target, build targets include: native, windows-x86_64, ohos-aarch64, ohos-arm, ohos-x86_64")
        sys.exit(1)
...
if __name__ == "__main__":
    ...
    b.add_argument(
        "--target",
        choices=["native", "windows-x86_64", "ohos-aarch64", "ohos-arm", "ohos-x86_64"],
        metavar="TARGET",
        default="native",
