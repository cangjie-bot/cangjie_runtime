...
namespace {
bool IsSameRootPackage(TypeInfo* itf1, TypeInfo* itf2)
{
...
bool IsSameRootPackage(TypeInfo* itf, ExtensionData* extensionData)
{
    if (itf == nullptr || extensionData == nullptr) {
        return false;
    }
    auto targetTI = extensionData->GetInterfaceTypeInfo();
    return itf == targetTI;
}
};
