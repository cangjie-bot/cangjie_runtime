...
extern "C" ArrayRef CJ_MCC_GetAllThreadSnapshot(const TypeInfo* arraySnapshot, const TypeInfo* arrayStackTrace,
                                                const TypeInfo* charArray)
{
    ScopedEnterSaferegion enterSaferegion(false);
...
extern "C" ThreadSnapshot CJ_MCC_GetCurrentThreadSnapshot(const TypeInfo* arrayStackTrace, const TypeInfo* charArray)
{
