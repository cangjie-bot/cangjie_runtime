...
class SignalStack {
public:
    SignalStack() noexcept : isMark(false),isUserAddSigHandler(true) {}
    ...
    bool IsUserAddSigHandler() { return isUserAddSigHandler; }

    void setUserAddSigHandlerFlag(bool flag) {
        isUserAddSigHandler = flag;
    }
