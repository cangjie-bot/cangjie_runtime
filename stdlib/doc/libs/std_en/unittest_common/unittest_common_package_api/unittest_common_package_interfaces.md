...
Example:
[Full example](#the-primary-use-of-datashrinkert)

### func provide()

```cangjie
func provide(): Iterable<T>F
```
...
Example:
[Full example](../../unittest_common/unittest_common_package_api/unittest_common_package_interfaces.md#the-primary-use-of-datashrinkert)
