...
- [InfoNotFoundException](reflect_package_exceptions.md#class-infonotfoundexception) - Thrown if the matching enum constructor cannot be found.
- [IllegalTypeException](reflect_package_exceptions.md#class-illegaltypeexception) - Thrown if `qualifiedName` does not refer to an enum type or enum constructor.
...
- [InvocationTargetException](reflect_package_exceptions.md#class-invocationtargetexception) - Thrown if `instance` is not an instance of the enum.
...
> **Note:**
>
> The constructor of `instance` must match this [EnumConstructorInfo](#class-enumconstructorinfo), otherwise an exception is thrown.
...
- [IllegalTypeException](reflect_package_exceptions.md#class-illegaltypeexception) - Thrown if `instance` is not an instance of this enum type or its constructor does not match this constructor.
...
- [InfoNotFoundException](reflect_package_exceptions.md#class-infonotfoundexception) - Thrown if matching type information cannot be obtained.
- [IllegalTypeException](reflect_package_exceptions.md#class-illegaltypeexception) - Thrown if the retrieved type information is not an enum type.
