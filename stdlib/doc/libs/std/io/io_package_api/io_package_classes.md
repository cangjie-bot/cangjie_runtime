...
main(): Unit {
    ...
    // 检查流是否关闭
    println("Is closed before close(): " + bufferedStream.isClosed().toString())
    
    // 关闭流
    bufferedStream.close()
    
    // 检查流是否关闭
    println("Is closed after close(): " + bufferedStream.isClosed().toString())
}
```
...
main(): Unit {
    ...
    // 输出初始未读数据量
    println("Initial Remain Length: " + bufferedStream.remainLength.toString())
    ...
    // 输出读取后的未读数据量
    println("Remain Length after reading 5 bytes: " + bufferedStream.remainLength.toString())
}
```
...
main(): Unit {
    ...
    println("Default capacity: " + buffer.capacity.toString())
    
    let buffer2 = ByteBuffer(1024)
    println("Custom capacity: " + buffer2.capacity.toString())
}
```
...
main(): Unit {
    let buffer = ByteBuffer("Hello World".toArray())
    println("Initial position: " + buffer.position.toString())
    
    // 读取一些数据
    let data = Array<Byte>(5, repeat: 0)
    buffer.read(data)
    println("Position after reading 5 bytes: " + buffer.position.toString())
}
```
...
main(): Unit {
    ...
    println("Length after writing: " + buffer.length.toString())
}
```
...
main(): Unit {
    let buffer = ByteBuffer("Hello World".toArray())
    println("Initial remain length: " + buffer.remainLength.toString())
    
    // 读取一些数据
    let data = Array<Byte>(5, repeat: 0)
    buffer.read(data)
    println("Remain length after reading 5 bytes: " + buffer.remainLength.toString())
}
```
...
main(): Unit {
    ...
    println("Total bytes read: " + totalBytesRead.toString())
...
main(): Unit {
    ...
    // 检查流是否关闭
    println("Is closed before close(): " + stringReader.isClosed().toString())
    
    // 关闭流
    stringReader.close()
    
    // 检查流是否关闭
    println("Is closed after close(): " + stringReader.isClosed().toString())
}
```
...
main(): Unit {
    ...
    // 输出当前光标位置
    println("Position: " + stringReader.position.toString())
}
```
...
main(): Unit {
    ...
    println("Position : " + stringReader.position.toString())
    println("Length : " + stringReader.length.toString())
    println("Remain Length : " + stringReader.remainLength.toString())

    /* 移动光标到指定位置，虽然超过了流中数据末尾但是合法的 */
    println("Position after seek() : " + stringReader.seek(SeekPosition.Current(11)).toString())
...
main(): Unit {
    ...
    // 检查流是否关闭
    println("Is closed before close(): " + stringWriter.isClosed().toString())
    
    // 关闭流
    stringWriter.close()
    
    // 检查流是否关闭
    println("Is closed after close(): " + stringWriter.isClosed().toString())
}
```
...
main(): Unit {
    ...
    /* 移动光标到指定位置，虽然超过了流中数据末尾但是合法的 */
    println("Position after seek() : " + stringWriter.seek(SeekPosition.Current(11)).toString())
