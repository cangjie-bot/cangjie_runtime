...
[动态测试](../../unittest/unittest_samples/unittest_dynamic_tests.md#introduction-to-dynamic-testing)

对于大多数情况，你无需编程式地更改配置。请改用以下方式：
[@Configure 宏](../../unittest_testmacro/unittest_testmacro_package_api/unittest_testmacro_package_macros.md#configure-macro)
