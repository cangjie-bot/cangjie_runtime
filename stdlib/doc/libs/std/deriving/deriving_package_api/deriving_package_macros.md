...
参考示例：[Deriving 示例](../deriving_samples/deriving_user_guide.md#deriving-示例)

## `@DeriveExclude` 宏

功能：`DeriveExclude` 可为已被 [@Derive 宏](#derive-宏)修饰的声明[排除不需要处理的字段](../deriving_samples/deriving_user_guide.md#包含和排除)，字段默认被 Deriving 处理。

参考示例：[包含和排除](../deriving_samples/deriving_user_guide.md#包含和排除)
...
参考示例：[变更顺序](../deriving_samples/deriving_user_guide.md#变更顺序)
