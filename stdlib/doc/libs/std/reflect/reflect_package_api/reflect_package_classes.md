...
[TypeInfo](reflect_package_classes.md#class-typeinfo) 的子类包括 [PrimitiveTypeInfo](reflect_package_classes.md#class-primitivetypeinfo)、[StructTypeInfo](reflect_package_classes.md#class-structtypeinfo)、[ClassTypeInfo](reflect_package_classes.md#class-classtypeinfo)、[InterfaceTypeInfo](reflect_package_classes.md#class-interfacetypeinfo) 和 [TupleTypeInfo](#class-tupletypeinfo)，分别对应基本数据类型，`struct` 数据类型，`class` 数据类型，`interface` 数据类型和元组数据类型的类型信息。
