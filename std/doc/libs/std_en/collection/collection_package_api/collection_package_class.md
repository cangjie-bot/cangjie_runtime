...
- elements: [Collection](../../core/core_package_api/core_package_interfaces.md#interface-collectiont)\<T> - The input collection.```cangjie
public init(capacity: Int64)
```
...
- [String](../../core/core_package_api/core_package_structs.md#struct-string) - The resulting string.```markdown
## class ArrayQueue\<T>
...
Return Value:
- [TreeSet](collection_package_class.md#class-treesett-where-t--comparablet)\<T> - A new set containing symmetric difference elements.```markdown
public func subsetOf(other: ReadOnlySet<T>): Bool
```
