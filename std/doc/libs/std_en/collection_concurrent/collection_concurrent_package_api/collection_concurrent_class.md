...
Functionality: Array-based Blocking Queue data structure and related operations.
...
Functionality: Returns the number of elements in this [ArrayBlockingQueue](collection_concurrent_class.md#class-arrayblockingqueuee).
...
Functionality: The capacity of this [ArrayBlockingQueue](collection_concurrent_class.md#class-arrayblockingqueuee).
...
Functionality: Constructs an [ArrayBlockingQueue](collection_concurrent_class.md#class-arrayblockingqueuee) with the specified capacity.
...
Functionality: Constructs an [ArrayBlockingQueue](collection_concurrent_class.md#class-arrayblockingqueuee) with specified capacity and initial elements from the iterator.

> **Note:**
>
> This will be deprecated in future versions. Equivalent functionality can be achieved by creating an empty queue and then sequentially adding elements from the collection.
...
Functionality: Blocking enqueue operation that adds an element to the tail of the queue. Blocks if the queue is full.
...
Functionality: Blocking enqueue operation that adds an element to the tail of the queue, waiting for specified duration if the queue is full. If timeout is negative, performs immediate enqueue and returns operation result.
...
Functionality: Blocking dequeue operation that retrieves and removes the head element.
...
Functionality: Blocking dequeue operation that retrieves and removes the head element, waiting for specified duration if queue is empty. If timeout is negative, performs immediate dequeue and returns operation result.
...
Functionality: Blocking enqueue operation that adds an element to the tail of the queue.
...
Functionality: Blocking enqueue operation that adds an element to the tail of the queue, waiting for specified duration if queue is full. If timeout is negative, performs immediate enqueue and returns operation result.
...
Functionality: Retrieves the head element.
...
Functionality: Non-blocking retrieval of the head element.
...
Functionality: Blocking dequeue operation that retrieves and removes the head element. Blocks if the queue is empty.
...
> **Note:**
>
> This method will be deprecated in future versions. To achieve equivalent functionality, first create an empty queue and then add the array elements to the queue sequentially.
...
> **Note:**
>
> This method will be deprecated in future versions. To achieve equivalent functionality, first create an empty queue and then add the collection elements to the queue sequentially.
...
Function: This class primarily implements the iterator functionality for [ConcurrentHashMap](collection_concurrent_class.md#class-concurrenthashmapk-v-where-k--hashable--equatablek).
...
> **Note:**
>
> **Deprecated in future versions**. To achieve equivalent functionality, first create an empty queue, then sequentially add elements from the [Collection](../../core/core_package_api/core_package_interfaces.md#interface-collectiont).
