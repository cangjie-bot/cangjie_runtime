...
#### func saturatingAdd(Int8)```cangjie
...
#### func saturatingSub(Int8)```cangjie
...
- y: [UInt64](../../core/core_package_api/core_package_intrinsics.md#uint64) - 左移位数。
...
- y: [UInt64](../../core/core_package_api/core_package_intrinsics.md#uint64) - 右移位数。
...
When the shift count is greater than or equal to the operand bit width, high bits are truncated. For example, when shifting a value of type [Int8](../../core/core_package_api/core_package_intrinsics.md#int8), if y (shift count) is greater than or equal to 8, only the lower 3 bits of y are taken as the shift count to ensure it remains between 0 and 7.
...
- y: [Int16](../../core/core_package_api/core_package_intrinsics.md#int16) - Divisor.Return Value:
...
When overflow occurs during operation, high bits are truncated; otherwise, returns the operation result.
...
When the right operand is greater than or equal to the bit width of the left operand, the lower 4 bits of the right operand are used as the shift count.
...
Return Value:- [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) - Result of the addition operation.
...
When the right operand is greater than or equal to the bit width of the left operand, the lower 5 bits of the right operand are taken as the shift count.
...
- [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) - Result of left shift operation.
...
- [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) - Result of right shift operation.
...
- [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) - Result of subtraction operation.
