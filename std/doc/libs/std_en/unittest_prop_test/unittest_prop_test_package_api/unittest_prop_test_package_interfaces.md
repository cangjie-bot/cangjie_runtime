...
- [Generator](../../unittest/unittest_package_api/unittest_package_interfaces.md#interface-generatort)\<Int16> - Generator for random Int16 values.
...
- [Generator](../../unittest/unittest_package_api/unittest_package_interfaces.md#interface-generatort)\<Int32> - Generator for random Int32 values.
...
- [Generator](../../unittest/unittest_package_api/unittest_package_interfaces.md#interface-generatort)\<Int64> - Generator for random Int64 values.
...
- [Generator](../../unittest/unittest_package_api/unittest_package_interfaces.md#interface-generatort)\<Int8> - Generator for random Int8 values.
...
- [Generator](../../unittest/unittest_package_api/unittest_package_interfaces.md#interface-generatort)\<IntNative> - Generator for random IntNative values.
...
- [Generator](../../unittest/unittest_package_api/unittest_package_interfaces.md#interface-generatort)\<UInt8> - Generator for random values of type UInt8.- [Arbitrary](#interface-arbitraryt)\<[UInt32](../../core/core_package_api/core_package_intrinsics.md#uint32)>
...
Function: Implements the [Arbitrary](#interface-arbitraryt)\<T> interface for [Geek Time](https://time.geekbang.org/) [UInt64](../../core/core_package_api/core_package_intrinsics.md#uint64).
...
Return Value:- [Generator](../../unittest/unittest_package_api/unittest_package_interfaces.md#interface-generatort)\<UIntNative> - Generator for random values of type UIntNative.
...
Function: Implements the [Arbitrary](#interface-arbitraryt)\<T> interface for [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<T>, where T must implement [Arbitrary](#interface-arbitraryt)\<T>.
...
Function: Implements the [Arbitrary](#interface-arbitraryt)\<T> interface for [Option](../../core/core_package_api/core_package_enums.md#enum-optiont)\<T>, where T must implement [Arbitrary](#interface-arbitraryt)\<T>.
...
Function: Implements the [Arbitrary](#interface-arbitraryt) interface for [ArrayList](../../collection/collection_package_api/collection_package_class.md#class-arraylistt)\<T>, where T must implement [Arbitrary](#interface-arbitraryt)\<T>.
...
Function: Accesses tuple elements by index.
...
Function: Obtains a pseudo-random boolean value.
...
Function: Obtains a pseudo-random [Float16](../../core/core_package_api/core_package_intrinsics.md#float16) value within the range [0.0, 1.0).
...
Function: Obtains a pseudo-random [Float32](../../core/core_package_api/core_package_intrinsics.md#float32) value within the range [0.0, 1.0).
...
Function: Obtains a pseudo-random [Float64](../../core/core_package_api/core_package_intrinsics.md#float64) value within the range [0.0, 1.0).
...
Function: Obtains a [Float64](../../core/core_package_api/core_package_intrinsics.md#float64) value following a Gaussian distribution with specified mean and standard deviation.

By default, returns a [Float64](../../core/core_package_api/core_package_intrinsics.md#float64) value following a Gaussian distribution with mean 0.0 and standard deviation 1.0. The mean parameter determines the distribution's central location, while the standard deviation parameter controls its dispersion. This function internally calls `nextGaussianFloat64Implement` for implementation. When a subclass inherits from [Random](../../random/random_package_api/random_package_classes.md#class-random) and overrides the `nextGaussianFloat64Implement` function, invoking this function on the subclass instance will return the overridden implementation's result.Parameters:
...
- [Float64](../../core/core_package_api/core_package_intrinsics.md#float64) - A [Float64](../../core/core_package_api/core_package_intrinsics.md#float64) value following the specified Gaussian distribution.
...
Function: Obtains a pseudo-random [Int16](../../core/core_package_api/core_package_intrinsics.md#int16) value.
...
Function: Obtains a pseudo-random [Int16](../../core/core_package_api/core_package_intrinsics.md#int16) value in the range [0, `upper`).

Parameters:

- upper: [Int16](../../core/core_package_api/core_package_intrinsics.md#int16) - Upper bound (exclusive) for the generated pseudo-random number, range (0, [Int16](../../core/core_package_api/core_package_intrinsics.md#int16).Max].
...
Function: Obtains a pseudo-random [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) value.
...
Function: Obtains a pseudo-random [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) value in the range [0, `upper`).

Parameters:

- upper: [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) - Upper bound (exclusive) for the generated pseudo-random number, range (0, [Int32](../../core/core_package_api/core_package_intrinsics.md#int32).Max].
...
Function: Obtains a pseudo-random [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) value.
...
Function: Obtains a pseudo-random [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) value in the range [0, `upper`).

Parameters:

- upper: [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) - Upper bound (exclusive) for the generated pseudo-random number, range (0, [Int64](../../core/core_package_api/core_package_intrinsics.md#int64).Max].
...
- upper: [Int8](../../core/core_package_api/core_package_intrinsics.md#int8) - The upper bound (exclusive) for the generated pseudo-random number, with valid range (0, [Int8](../../core/core_package_api/core_package_intrinsics.md#int8).Max].
...
- upper: [UInt16](../../core/core_package_api/core_package_intrinsics.md#uint16) - The upper bound (exclusive) for the generated pseudo-random number, with valid range (0, [UInt16](../../core/core_package_api/core_package_intrinsics.md#uint16).Max].
...
Function: Gets a pseudo-random number of type [UInt32](../../core/core_package_api/core_package_intrinsics.md#uint32) within the range [0, `upper`).

Parameters:

- upper: [UInt32](../../core/core_package_api/core_package_intrinsics.md#uint32) - The upper bound of the pseudo-random number range (exclusive), with valid range (0, [UInt32](../../core/core_package_api/core_package_intrinsics.md#uint32).Max].
...
Function: Gets a pseudo-random number of type [UInt64](../../core/core_package_api/core_package_intrinsics.md#uint64).
...
Function: Gets a pseudo-random number of type [UInt64](../../core/core_package_api/core_package_intrinsics.md#uint64) within the range [0, `upper`).

Parameters:

- upper: [UInt64](../../core/core_package_api/core_package_intrinsics.md#uint64) - The upper bound of the pseudo-random number range (exclusive), with valid range (0, [UInt64](../../core/core_package_api/core_package_intrinsics.md#uint64).Max].
...
Function: Gets a pseudo-random number of type [UInt8](../../core/core_package_api/core_package_intrinsics.md#uint8).
...
Function: Gets a pseudo-random number of type [UInt8](../../core/core_package_api/core_package_intrinsics.md#uint8) within the range [0, `upper`).

Parameters:

- upper: [UInt8](../../core/core_package_api/core_package_intrinsics.md#uint8) - The upper bound of the pseudo-random number range (exclusive), with valid range (0, [UInt8](../../core/core_package_api/core_package_intrinsics.md#uint8).Max].
...
Function: Gets a pseudo-random number of type [UIntNative](../../core/core_package_api/core_package_intrinsics.md#uintnative).

Return Value:

- [UIntNative](../../core/core_package_api/core_package_intrinsics.md#uintnative) - A pseudo-random number of type [UIntNative](../../core/core_package_api/core_package_intrinsics.md#uintnative).```cangjie
public open func nextUInt32(upper: UInt32): UInt32
```
...
Function: Gets a pseudo-random number of type [UInt16](../../core/core_package_api/core_package_intrinsics.md#uint16).
...
Function: Gets a pseudo-random number of type [UInt32](../../core/core_package_api/core_package_intrinsics.md#uint32).
...
- [UInt8](../../core/core_package_api/core_package_intrinsics.md#uint8) - A pseudo-random number of type [UInt8](../../core/core_package_api/core_package_intrinsics.md#uint8).- [Int8](../../core/core_package_api/core_package_intrinsics.md#int8) - A pseudo-random number of type [Int8](../../core/core_package_api/core_package_intrinsics.md#int8).
...
Function: Obtains a pseudo-random number of type [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative).
...
Function: Obtains a pseudo-random number of type [UInt16](../../core/core_package_api/core_package_intrinsics.md#uint16).
...
Function: Obtains a pseudo-random number of type [UIntNative](../../core/core_package_api/core_package_intrinsics.md#uintnative).
...
- [Iterable](../../core/core_package_api/core_package_interfaces.md#interface-iterablee)\<HashMap\<K, V>> - An iterator over a set of possible "smaller" values.
```