...
Function: Writes the Unicode character value of the specified [Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) to the standard output or standard error stream.

Parameters:

- v: [Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) - The value to be written.
