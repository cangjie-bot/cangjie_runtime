...
## const O_NOCTTY <sup>(deprecated)</sup>```cangjie
...
Type: [Int32](../../core/core_package_api/core_package_intrinsics.md#int32)```markdown
...
All technical details and formatting requirements have been fully preserved, with only repetitive explanatory text compressed to ensure complete output. All links and code blocks remain unchanged.