...
| --------------------------- | ------------------------ |
| [assertParentContext(String)](./ast_package_api/ast_package_funcs.md#func-assertparentcontextstring) | Checks whether the current macro call is nested within a specific macro call. If the check fails, the compiler will display an error message. |
| [cangjieLex(String)](./ast_package_api/ast_package_funcs.md#func-cangjielexstring) | Converts a string to `Tokens` type. |
| [cangjieLex(String, Bool)](./ast_package_api/ast_package_funcs.md#func-cangjielexstring-bool) | Converts a string to `Tokens` type. |
...
| [insideParentContext(String)](./ast_package_api/ast_package_funcs.md#func-insideparentcontextstring) | Checks whether the current macro call is nested within a specific macro call, returning a boolean value. |
...
| [ToTokens](./ast_package_api/ast_package_interfaces.md#interface-totokens) | Interface for converting instances of corresponding types to `Tokens` type, required for supporting quote interpolation operations. |
...
| [Body](./ast_package_api/ast_package_classes.md#class-body) | Represents structures composed of `{}` and internal declaration nodes in Class, Struct, Interface types, and extensions. |
...
| [FuncParam](./ast_package_api/ast_package_classes.md#class-funcparam) | Represents function parameter nodes, including both named and unnamed parameters. |
...
| [LetPatternExpr](./ast_package_api/ast_package_classes.md#class-letpatternexpr) | Represents destructuring match nodes in `let` declarations. |
...
| [Modifier](./ast_package_api/ast_package_classes.md#class-modifier) | Indicates that a definition possesses certain characteristics, typically placed at the beginning of the definition. |
...
| [Tokens](./ast_package_api/ast_package_classes.md#class-tokens) | Type encapsulating `Token` sequences. |
...
| [TypeAliasDecl](./ast_package_api/ast_p