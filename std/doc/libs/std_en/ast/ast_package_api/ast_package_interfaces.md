...
Function: Implements conversion from [Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) type to [Tokens](ast_package_classes.md#class-tokens).

Parent type:

- [ToTokens](#interface-totokens)

#### func toTokens()```cangjie
public func toTokens(): Tokens
```
