...
Function: Represents a built-in annotation node in the compiler.
...
Function: Gets or sets the sequence of arguments in [Annotation](ast_package_classes.md#class-annotation), such as `xxx` in `@CallingConv[xxx]`.
...
Function: Constructs an [Annotation](ast_package_classes.md#class-annotation) object based on the input lexical units.

Parameters:

- inputs: [Tokens](ast_package_classes.md#class-tokens) - The collection of lexical units ([Tokens](ast_package_classes.md#class-tokens)) to construct the [Annotation](ast_package_classes.md#class-annotation) type.
...
Function: Represents an actual argument node in a function call.
...
Function: Gets or sets the operator ":" in the [Argument](ast_package_classes.md#class-argument) node, which may be a lexical unit of [ILLEGAL](ast_package_enums.md#illegal).
...
Function: Gets or sets the identifier in the [Argument](ast_package_classes.md#class-argument) node, such as `arg` in `arg:value`, which may be a lexical unit of [ILLEGAL](ast_package_enums.md#illegal).

Type: [Token](ast_package_structs.md#struct-token)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the get or set [Token](ast_package_structs.md#struct-token) type is not an [IDENTIFIER](ast_package_enums.md#identifier) or the literal value of [Token](ast_package_structs.md#struct-token) is empty.
...
An [ArrayLiteral](ast_package_classes.md#class-arrayliteral) node: Represented in the format `[element1, element2, ... , elementN]`, where each `element` is an expression.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the set [Token](ast_package_structs.md#struct-token) is not the `as` operator.
...
Function: Gets or sets the target type in [AsExpr](ast_package_classes.md#class-asexpr).```markdown
...
Used to modify the value of the left operand to match the right operand. An [AssignExpr](ast_package_classes.md#class-assignexpr) node: `a = b`.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed into an [AssignExpr](ast_package_classes.md#class-assignexpr) node.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed into a [BinaryExpr](ast_package_classes.md#class-binaryexpr) node.
...
A [Block](ast_package_classes.md#class-block) is a structure consisting of a pair of matching braces and an optional sequence of expression declarations within, referred to as a "block."
...
Function: Represents the structure composed of `{}` and an internal set of declaration nodes in Class types, Struct types, Interface types, and extensions.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The collection of lexical units ([Tokens](ast_package_classes.md#class-tokens)) to construct a [CallExpr](ast_package_classes.md#class-callexpr) type.
...
A class definition uses the `class` keyword, followed by: optional modifiers, the `class` keyword, the class name, optional type parameters, optional parent class or interface specifications, optional generic constraints, and the class body definition.
...
Function: Gets or sets the class body in the [ClassDecl](ast_package_classes.md#class-classdecl) node.
...
Function: Gets or sets the parent class or interfaces in the [ClassDecl](ast_package_classes.md#class-classdecl) node.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The collection of lexical units ([Tokens](ast_package_classes.md#class-tokens)) to construct a [ClassDecl](ast_package_classes.md#class-classdecl) type.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The collection of lexical units ([Tokens](ast_package_classes.md#class-tokens)) to construct a [ConstPattern](ast_package_classes.md#class-constpattern) type.
...
A [Constructor](ast_package_classes.md#class-constructor) node: e.g., `Year` and `Month([Float32](../../core/core_package_api/core_package_intrinsics.md#float32), [Float32](../../core/core_package_api/core_package_intrinsics.md#float32))` in `enum TimeUnit { Year | Month([Float32](../../core/core_package_api/core_package_intrinsics.md#float32), [Float32](../../core/core_package_api/core_package_intrinsics.md#float32)) }`.

> **Note:**
>
> A [Constructor](ast_package_classes.md#class-constructor) may have no arguments or a set of arguments of different types.
...
### prop typeArguments```cangjie
public mut prop typeArguments: ArrayList<TypeNode>
```

Function: Gets or sets the collection of optional parameter type nodes for a [Constructor](ast_package_classes.md#class-constructor) node.
...
Function: Gets or sets the block expression in [DoWhileExpr](ast_package_classes.md#class-dowhileexpr).
...
Function: Gets or sets the `do` keyword in the [DoWhileExpr](ast_package_classes.md#class-dowhileexpr) node, where the D in keywordD is the uppercase first letter of the keyword `do`, representing the keyword `do`.

Type: [Token](ast_package_structs.md#struct-token)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the provided [Token](ast_package_structs.md#struct-token) is not the `do` keyword.
...
Function: Gets or sets the `while` keyword in the [DoWhileExpr](ast_package_classes.md#class-dowhileexpr) node, where the W in keywordW is the uppercase first letter of the keyword `while`, representing the keyword `while`.

Type: [Token](ast_package_structs.md#struct-token)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the provided [Token](ast_package_structs.md#struct-token) is not the `while` keyword.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The collection of lexical units ([Tokens](ast_package_classes.md#class-tokens)) to construct the [DoWhileExpr](ast_package_classes.md#class-dowhileexpr) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed into a [DoWhileExpr](ast_package_classes.md#class-dowhileexpr) node.
...
Enum definitions use the `enum` keyword, consisting of: optional modifiers, the `enum` keyword, the enum name, optional type parameters, optional parent interfaces, optional generic constraints, and the enum body definition.
...
Type: [ArrayList](../../collection/collection_package_api/collection_package_class.md#class-arraylistt)\<[Annotation](ast_package_classes.md#class-annotation)>### prop decls

```cangjie
public mut prop decls: ArrayList<Decl>
```

Function: Gets or sets members other than the constructor within an [EnumDecl](ast_package_classes.md#class-enumdecl) node.
...
Function: Gets or sets the optional `...` lexical unit in an [EnumDecl](ast_package_classes.md#class-enumdecl) node, which may be of type [ILLEGAL](ast_package_enums.md#illegal).

Type: [Token](ast_package_structs.md#struct-token)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the provided [Token](ast_package_structs.md#struct-token) is not a `...` lexical unit.
...
Function: Gets or sets the `{` lexical unit type in an [EnumDecl](ast_package_classes.md#class-enumdecl) node.

Type: [Token](ast_package_structs.md#struct-token)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the provided [Token](ast_package_structs.md#struct-token) is not a `{` lexical unit type.
...
Function: Gets or sets the sequence of `&` operator lexical units in the parent interface declaration of an [EnumDecl](ast_package_classes.md#class-enumdecl) node, which may be empty.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) used to construct the [EnumDecl](ast_package_classes.md#class-enumdecl) type.
...
Function: Gets or sets the sequence of `,` lexical units in an [EnumPattern](ast_package_classes.md#class-enumpattern) node, which may be empty.
...
Function: Gets or sets the constructor expression node in an [EnumPattern](ast_package_classes.md#class-enumpattern) node.
...
Function: Gets or sets the `(` lexical unit in an [EnumPattern](ast_package_classes.md#class-enumpattern) node.

Type: [Token](ast_package_structs.md#struct-token)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the provided [Token](ast_package_structs.md#struct-token) is not a `(`.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) used to construct the [EnumPattern](ast_package_classes.md#class-enumpattern) type.
...
Function: Represents a node used in exception pattern states.

For example, `e: Exception1 | Exception2`.
...
Function: Gets or sets the `:` operator lexical unit in an [ExceptTypePattern](ast_package_classes.md#class-excepttypepattern) node.
...
Function: Gets or sets the pattern node in an [ExceptTypePattern](ast_package_classes.md#class-excepttypepattern) node.
...
Function: Gets or sets the type list in an [ExceptTypePattern](ast_package_classes.md#class-excepttypepattern) node.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) used to construct the [ExceptTypePattern](ast_package_classes.md#class-excepttypepattern) type.
...
An extension is defined using the `extend` keyword. The extension declaration consists of: the `extend` keyword, the extended type, optional parent interface specification, optional generic constraints, and the extension body definition.
...
Function: The [ExtendDecl](ast_package_classes.md#class-extenddecl) node inherits from [Decl](ast_package_classes.md#class-decl), but does not support the `identifier` property. An exception is thrown when this property is accessed.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the provided [Token](ast_package_structs.md#struct-token) is not the `for` keyword.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the provided [Token](ast_package_structs.md#struct-token) is not the `in` keyword.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the provided [Token](ast_package_structs.md#struct-token) is not the `where` keyword.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The token collection ([Tokens](ast_package_classes.md#class-tokens)) used to construct the [ForInExpr](ast_package_classes.md#class-forinexpr) type.
...
A function is defined by an optional function modifier, the `func` keyword, the function name, an optional type parameter list, function parameters, an optional return type, and must include a function body, which is a block.
...
A [FuncParam](ast_package_classes.md#class-funcparam) node: `a: Int64` and `b: Float64` in `func foo(a: Int64, b: Float64) {...}`.
...
Function: Gets or sets the `=` token in function parameters with default values.
...
Function: Gets or sets the ":" token in formal parameters.
...
Function: Gets or sets the `!` token in named formal parameters.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - A boolean value; returns `true` if it is a parameter in the primary constructor.
...
Function: Gets or sets the `CFunc` keyword token in the [FuncType](ast_package_classes.md#class-functype) node. If it is not a `CFunc` type, an [ILLEGAL](ast_package_enums.md#illegal) token is returned.
...
Function: Gets or sets the lexical unit ")" for the [FuncType](ast_package_classes.md#class-functype) node.
...
> **Note:**
>
> Declared via the `<:` operator after `where`, consisting of a lower bound and an upper bound. The left side of `<:` is called the constraint lower bound, which can only be a type variable. The right side of `<:` is called the constraint upper bound, which can be a type.
...
Function: Gets or sets the constraint lower bound in the [GenericConstraint](ast_package_classes.md#class-genericconstraint) node.
...
Function: Gets or sets the collection of [TypeNode](ast_package_classes.md#class-typenode) type nodes for the constraint upper bounds in the [GenericConstraint](ast_package_classes.md#class-genericconstraint) node.
...
Function: Gets or sets the [Tokens](ast_package_classes.md#class-tokens) type for the type parameters in the [GenericParam](ast_package_classes.md#class-genericparam) node, which may be empty, such as `T1`, `T2`, and `T3` in `<T1, T2, T3>`.
...
- parameters: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the type parameters for [GenericParam](ast_package_classes.md#class-genericparam).
...
Decides which code branch to execute based on whether the condition is met. In an [IfExpr](ast_package_classes.md#class-ifexpr) node, `if` is a keyword, followed by parentheses containing either an expression or a destructuring match declared by `let`, then a [Block](ast_package_classes.md#class-block), followed by an optional `else` branch. The `else` branch starts with the `else` keyword, followed by a new `if` expression or a [Block](ast_package_classes.md#class-block).
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the current [IfExpr](ast_package_classes.md#class-ifexpr) node has no else branch node.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the set [Token](ast_package_structs.md#struct-token) is not the `else` keyword.
...
Function: Gets or sets the sequence of lexical units for the prefix part of the full package name in an [ImportContent](ast_package_classes.md#class-importcontent) node, which may be empty. For example, `a` and `b` in `import a.b.c`.
...
Function: Gets or sets the sequence of lexical units used to separate sub-packages in the full package name in an [ImportContent](ast_package_classes.md#class-importcontent) node, which may be empty. For example, the two "." in `import a.b.c`.
...
Function: Gets or sets the imported item in an [ImportContent](ast_package_classes.md#class-importcontent) node, which may be a top-level definition/declaration in the package or a sub-package name.
...
Function: Gets or sets the sequence of lexical units for the alias of the imported definition/declaration in an [ImportContent](ast_package_classes.md#class-importcontent) node, non-empty only when `importKind` is `ImportKind.Alias`. For example, `as yyy` in `import packageName.xxx as yyy`.
...
Function: Gets or sets the "{" operator lexical unit in an [ImportContent](ast_package_classes.md#class-importcontent) node, non-empty only when `importKind` is `ImportKind.Multi`.
...
Function: Gets or sets all imported items in an [ImportContent](ast_package_classes.md#class-importcontent) node, non-empty only when `importKind` is `ImportKind.Multi`.
...
Function: Gets or sets the sequence of "," lexical units in an [ImportContent](ast_package_classes.md#class-importcontent) node, non-empty only when `importKind` is `ImportKind.Multi`.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Whether the [ImportContent](ast_package_classes.md#class-importcontent) node is a wildcard import.
...
Function: Determines whether the [ImportContent](ast_package_classes.md#class-importcontent) node imports multiple top-level definitions/declarations.

Return Value:

- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Whether the [ImportContent](ast_package_classes.md#class-importcontent) node imports multiple top-level definitions/declarations.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Whether the [ImportContent](ast_package_classes.md#class-importcontent) node is a single import.
...
> **Note:**
>
> An import node starts with an optional accessibility modifier (`public/protected/internal/private`) followed by the `import` keyword. For example, in `import pkga.pkgb.item`, `pkga.pkgb` is the package name containing the imported top-level definition/declaration, and `item` is the imported top-level definition/declaration.
...
Function: Gets or sets the modifier in an [ImportList](ast_package_classes.md#class-importlist) node, which may be an [ILLEGAL](ast_package_enums.md#illegal) lexical unit.
...
Function: Gets or sets the `import` keyword lexical unit in an [ImportList](ast_package_classes.md#class-importlist) node, where `I` is the first letter of the keyword.
...
Function: Gets or sets the specific imported item in an [ImportList](ast_package_classes.md#class-importlist) node. For example, the `a.b.c` part in `import a.b.c`.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - A sequence of lexical unit collections ([Tokens](ast_package_classes.md#class-tokens)) that will be used to construct an [ImportList](ast_package_classes.md#class-importlist) type.
...
Function: Represents expressions containing increment (`++`) or decrement (`--`) operators.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - A lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) that will be used to construct an [IncOrDecExpr](ast_package_classes.md#class-incordecexpr) type.
...
Interface definitions use the `interface` keyword and consist of: optional modifiers, the `interface` keyword, the interface name, optional type parameters, optional parent interface specification, optional generic constraints, and the interface body definition.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - A lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) that will be used to construct an [InterfaceDecl](ast_package_classes.md#class-interfacedecl) type.
...
Function: Gets or sets the `is` operator within the [IsExpr](ast_package_classes.md#class-isexpr) node.
...
Function: Gets or sets the target type within the [IsExpr](ast_package_classes.md#class-isexpr) node.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - A lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) that will be used to construct an [IsExpr](ast_package_classes.md#class-isexpr) type.
...
- kind: [Tokens](ast_package_classes.md#class-tokens) - A lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) that will be used to construct a [JumpExpr](ast_package_classes.md#class-jumpexpr) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed into a [JumpExpr](ast_package_classes.md#class-jumpexpr) node.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [LambdaExpr](ast_package_classes.md#class-lambdaexpr) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [LambdaExpr](ast_package_classes.md#class-lambdaexpr) node.
...
Function: Represents a destructuring match node for `let` declarations.
...
Function: Gets or sets the expression after the `<-` operator in the [LetPatternExpr](ast_package_classes.md#class-letpatternexpr) node.
...
Function: Gets or sets the pattern after `let` in the [LetPatternExpr](ast_package_classes.md#class-letpatternexpr) node.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [LetPatternExpr](ast_package_classes.md#class-letpatternexpr) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [LetPatternExpr](ast_package_classes.md#class-letpatternexpr) node.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [LitConstExpr](ast_package_classes.md#class-litconstexpr) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [ParenExpr](ast_package_classes.md#class-parenexpr) node.
...
Function: Gets or sets the function body in the [MacroDecl](ast_package_classes.md#class-macrodecl) node.
...
Function: Gets or sets the return type of the function in the [MacroDecl](ast_package_classes.md#class-macrodecl) node.

Type: [TypeNode](ast_package_classes.md#class-typenode)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the return type of the function in the [MacroDecl](ast_package_classes.md#class-macrodecl) node is a default value.
...
Function: Gets or sets the parameters in the [MacroDecl](ast_package_classes.md#class-macrodecl) node.

Type: [ArrayList](../../collection/collection_package_api/collection_package_class.md#class-arraylistt)\<[FuncParam](ast_package_classes.md#class-funcparam)>public mut prop rSquare: Token
```

Function: Gets or sets the "]" for the [MacroExpandExpr](ast_package_classes.md#class-macroexpandexpr) attribute macro invocation.
...
Function: Gets or sets the "(" for the [MacroExpandExpr](ast_package_classes.md#class-macroexpandexpr) macro invocation.
...
Function: Gets or sets the input for the [MacroExpandExpr](ast_package_classes.md#class-macroexpandexpr) attribute macro invocation.
...
Function: Gets or sets the input for the [MacroExpandExpr](ast_package_classes.md#class-macroexpandexpr) macro invocation.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [MacroExpandExpr](ast_package_classes.md#class-macroexpandexpr) node.```markdown
public mut prop rSquare: Token
```
...
Function: Gets the [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) type information corresponding to the key value.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Returns the [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) type information corresponding to the key value.

Exceptions:

- [Exception](../../core/core_package_api/core_package_exceptions.md#class-exception) - Throws an exception when there is no [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) type information corresponding to the key value.
...
Function: Gets the [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) type information corresponding to the key value.
...
- [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) - Returns the [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) type information corresponding to the key value.

Exceptions:

- [Exception](../../core/core_package_api/core_package_exceptions.md#class-exception) - Throws an exception when there is no [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) type information corresponding to the key value.
...
Function: Gets the [String](../../core/core_package_api/core_package_structs.md#struct-string) type information corresponding to the key value.
...
- [String](../../core/core_package_api/core_package_structs.md#struct-string) - Returns the [String](../../core/core_package_api/core_package_structs.md#struct-string) type information corresponding to the key value.

Exceptions:

- [Exception](../../core/core_package_api/core_package_exceptions.md#class-exception) - Throws an exception when there is no [String](../../core/core_package_api/core_package_structs.md#struct-string) type information corresponding to the key value.
...
Function: Gets the [Tokens](ast_package_classes.md#class-tokens) type information corresponding to the key value.
...
- [Tokens](ast_package_classes.md#class-tokens) - Returns the [Tokens](ast_package_classes.md#class-tokens) type information corresponding to the key value.

Exceptions:

- [Exception](../../core/core_package_api/core_package_exceptions.md#class-exception) - Throws an exception when there is no [Tokens](ast_package_classes.md#class-tokens) type information corresponding to the key value.
...
Function: Checks whether there is information corresponding to the key value.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Returns true if there is information corresponding to the key value; otherwise, returns false.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the function return type of the [MainDecl](ast_package_classes.md#class-maindecl) node is a default value.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed as a [MainDecl](ast_package_classes.md#class-maindecl) node.
...
> **Note:**
>
> - [MatchCase](ast_package_classes.md#class-matchcase) starts with the keyword `case`, followed by an [Expr](ast_package_classes.md#class-expr) or one or more `pattern`s of the same kind separated by `|`, an optional `patternguard`, a `=>`, and a series of declarations or expressions.
...
Function: Gets or sets the lexical unit of the `=>` operator in [MatchCase](ast_package_classes.md#class-matchcase).
...
Function: Gets or sets the sequence of lexical units for the `|` operator in [MatchCase](ast_package_classes.md#class-matchcase), which may be empty.
...
Function: Gets or sets the lexical unit of the `case` keyword in [MatchCase](ast_package_classes.md#class-matchcase).
...
Function: Gets or sets the optional lexical unit of the `where` keyword in [MatchCase](ast_package_classes.md#class-matchcase), which may be an [ILLEGAL](ast_package_enums.md#illegal) lexical unit.
...
Function: Gets or sets the list of `pattern`s following `case` in [MatchCase](ast_package_classes.md#class-matchcase).
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the set [Token](ast_package_structs.md#struct-token) is not the `match` keyword.
...
Function: Gets or sets the "{" following [MatchExpr](ast_package_classes.md#class-matchexpr).
...
Function: Gets or sets the `matchCase` within [MatchExpr](ast_package_classes.md#class-matchexpr). A `matchCase` starts with the keyword `case`, followed by one or more [Pattern](ast_package_classes.md#class-pattern) or [Expr](ast_package_classes.md#class-expr) nodes, as detailed in [MatchCase](ast_package_classes.md#class-matchcase).
...
public mut prop rParen: Token
``````
Function: Gets or sets the closing ")" after [MatchExpr](ast_package_classes.md#class-matchexpr).
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [MatchExpr](ast_package_classes.md#class-matchexpr) node.
...
Function: Gets or sets the member name in the [MemberAccess](ast_package_classes.md#class-memberaccess) node.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [MemberAccess](ast_package_classes.md#class-memberaccess) node.
...
Function: Indicates that the definition has certain characteristics, typically placed at the beginning of the definition.

A [Modifier](ast_package_classes.md#class-modifier) node: `public` in `public func foo()`.
...
Function: Traverses the current syntax tree node and its child nodes. To terminate the traversal of child nodes early, override the `visit` function and call the `breakTraverse` function to terminate traversal early. Refer to [Custom Visitor Function Traversing AST Object Example](../ast_samples/traverse.md).
...
An [OptionalExpr](ast_package_classes.md#class-optionalexpr) node: The `a?` in `a?.b, a?(b), a?[b]`.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [OptionalExpr](ast_package_classes.md#class-optionalexpr) type.
...
Function: Gets or sets the name of the current package in the [PackageHeader](ast_package_classes.md#class-packageheader) node. If the current package is the root package, it is the full package name; if it is a subpackage, it is the name after the last ".".
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) sequence to construct the [PackageHeader](ast_package_classes.md#class-packageheader) type.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [ParenExpr](ast_package_classes.md#class-parenexpr) type.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The token collection ([Tokens](ast_package_classes.md#class-tokens)) used to construct the [ParenType](ast_package_classes.md#class-parentype) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [ParenType](ast_package_classes.md#class-parentype) node.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The token collection ([Tokens](ast_package_classes.md#class-tokens)) used to construct the [PrefixType](ast_package_classes.md#class-prefixtype) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [PrefixType](ast_package_classes.md#class-prefixtype) node.
...
Function: Gets or sets the constructor body in a [PrimaryCtorDecl](ast_package_classes.md#class-primaryctordecl) node.
...
Function: Gets or sets the "(" token in a [PrimaryCtorDecl](ast_package_classes.md#class-primaryctordecl) node.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [PrimaryCtorDecl](ast_package_classes.md#class-primaryctordecl) node.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Returns true if the current node is a `Const` type node; otherwise, returns false.
...
Function: Gets or sets the keyword used to construct a [PrimitiveType](ast_package_classes.md#class-primitivetype), such as [Int8](../../core/core_package_api/core_package_intrinsics.md#int8).
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The token collection ([Tokens](ast_package_classes.md#class-tokens)) used to construct the [PrimitiveType](ast_package_classes.md#class-primitivetype) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [PrimitiveType](ast_package_classes.md#class-primitivetype) node.
...
[PrimitiveTypeExpr](ast_package_classes.md#class-primitivetypeexpr) node: Compiler-built-in primitive types appearing as expressions in nodes. Example: [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) in [Int64](../../core/core_package_api/core_package_intrinsics.md#int64).toSting().
...
Function: Gets or sets the primitive type keyword in a [PrimitiveTypeExpr](ast_package_classes.md#class-primitivetypeexpr) node.
...
- kind: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) used to construct the [PrimitiveTypeExpr](ast_package_classes.md#class-primitivetypeexpr) type.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) sequence used to construct the [Program](ast_package_classes.md#class-program) type.
...
Function: Represents a property definition node.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the [PropDecl](ast_package_classes.md#class-propdecl) node lacks a getter function.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the [PropDecl](ast_package_classes.md#class-propdecl) node lacks a setter function.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) used to construct the [PropDecl](ast_package_classes.md#class-propdecl) type.
...
Function: Gets or sets the member identifier in the [QualifiedType](ast_package_classes.md#class-qualifiedtype) node, such as `a` in `var a : T.a`.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the set [Token](ast_package_structs.md#struct-token) is not a right angle bracket.### prop typeArguments

```cangjie
public mut prop typeArguments: ArrayList<TypeNode>
```

Purpose: Gets or sets the list of instantiated types in a [QualifiedType](ast_package_classes.md#class-qualifiedtype) node, such as [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) in `T.a<Int32>`. The list may be empty.
...
Purpose: Constructs a default [QualifiedType](ast_package_classes.md#class-qualifiedtype) object.
...
Purpose: Constructs a [QualifiedType](ast_package_classes.md#class-qualifiedtype) object.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [QualifiedType](ast_package_classes.md#class-qualifiedtype) node.
...
Purpose: Represents a `quote` expression node.
...
Purpose: Gets or sets the internal quoted expression nodes enclosed by `()` in a [QuoteExpr](ast_package_classes.md#class-quoteexpr).
...
Purpose: Gets or sets the `quote` keyword in a [QuoteExpr](ast_package_classes.md#class-quoteexpr).

Type: [Token](ast_package_structs.md#struct-token)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the set [Token](ast_package_structs.md#struct-token) is not a `quote` keyword.
...
Purpose: Gets or sets the "(" in a [QuoteExpr](ast_package_classes.md#class-quoteexpr).
...
Purpose: Constructs a default [QuoteExpr](ast_package_classes.md#class-quoteexpr) object.
...
Purpose: Constructs a [QuoteExpr](ast_package_classes.md#class-quoteexpr) object.

Parameters:

- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [QuoteExpr](ast_package_classes.md#class-quoteexpr) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [QuoteExpr](ast_package_classes.md#class-quoteexpr) node.
...
Purpose: Gets the [Tokens](ast_package_classes.md#class-tokens) within a [QuoteToken](ast_package_classes.md#class-quotetoken).
...
Purpose: Gets or sets the ":" operator in a [RangeExpr](ast_package_classes.md#class-rangeexpr).
...
Purpose: Gets or sets the end value in a [RangeExpr](ast_package_classes.md#class-rangeexpr).

Type: [Expr](ast_package_classes.md#class-expr)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the end expression is omitted. Only occurs when a [Range](../../core/core_package_api/core_package_structs.md#struct-ranget-where-t--countablet--comparablet--equatablet)\<[Int64](../../core/core_package_api/core_package_intrinsics.md#int64)> instance is used in an empty subscript operator `[]` scenario.
...
Purpose: Gets or sets the [Range](../../core/core_package_api/core_package_structs.md#struct-ranget-where-t--countablet--comparablet--equatablet) operator in a [RangeExpr](ast_package_classes.md#class-rangeexpr).
...
Purpose: Gets or sets the start value in a [RangeExpr](ast_package_classes.md#class-rangeexpr).

Type: [Expr](ast_package_classes.md#class-expr)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the start expression is omitted. Only occurs when a [Range](../../core/core_package_api/core_package_structs.md#struct-ranget-where-t--countablet--comparablet--equatablet)\<[Int64](../../core/core_package_api/core_package_intrinsics.md#int64)> instance is used in an empty subscript operator `[]` scenario.
...
Purpose: Gets or sets the difference between two consecutive elements in the sequence within a [RangeExpr](ast_package_classes.md#class-rangeexpr).

Type: [Expr](ast_package_classes.md#class-expr)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the difference between consecutive elements in the sequence is not set in a [RangeExpr](ast_package_classes.md#class-rangeexpr).
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [RangeExpr](ast_package_classes.md#class-rangeexpr) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed as a [RangeExpr](ast_package_classes.md#class-rangeexpr) node.
...
Purpose: Gets or sets the sequence of "," lexical units in a [RefExpr](ast_package_classes.md#class-refexpr) node, which may be empty.
...
Purpose: Gets or sets the identifier of a custom type in a [RefExpr](ast_package_classes.md#class-refexpr) node.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical token collection ([Tokens](ast_package_classes.md#class-tokens)) used to construct the [RefExpr](ast_package_classes.md#class-refexpr) type.
...
Function: Gets or sets the sequence of "," lexical tokens in a [RefType](ast_package_classes.md#class-reftype) node, which may be empty.
...
Function: Gets or sets the keyword used to construct the [RefType](ast_package_classes.md#class-reftype) type, such as `A` in `var a : A = A()`.
...
Function: Gets or sets the left angle bracket lexical token in a [RefType](ast_package_classes.md#class-reftype) node, which may be an [ILLEGAL](ast_package_enums.md#illegal) token.
...
Function: Gets or sets the right angle bracket lexical token in a [RefType](ast_package_classes.md#class-reftype) node, which may be an [ILLEGAL](ast_package_enums.md#illegal) token.
...
Function: Gets or sets the list of instantiation types in a [RefType](ast_package_classes.md#class-reftype) node, which may be empty. Example: [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) in `var a : Array<Int32>`.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical token collection ([Tokens](ast_package_classes.md#class-tokens)) used to construct the [RefType](ast_package_classes.md#class-reftype) type.
...
Function: Gets or sets the expression node within a [ReturnExpr](ast_package_classes.md#class-returnexpr) node.
...
Function: Gets or sets the keyword in a [ReturnExpr](ast_package_classes.md#class-returnexpr) node.
...
Function: Gets or sets the `spawn` keyword in a [SpawnExpr](ast_package_classes.md#class-spawnexpr).
...
Function: Gets or sets the "(" in a [SpawnExpr](ast_package_classes.md#class-spawnexpr).
...
Function: Gets or sets the parameterless closure in a [SpawnExpr](ast_package_classes.md#class-spawnexpr).
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the provided [Token](ast_package_structs.md#struct-token) is not ")".### prop threadContext
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the [SpawnExpr](ast_package_classes.md#class-spawnexpr) does not contain a context expression.
...
Struct definitions use the `struct` keyword, followed by: optional modifiers, the `struct` keyword, the struct name, optional type parameters, optional parent interfaces, optional generic constraints, and the struct body definition.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [SubscriptExpr](ast_package_classes.md#class-subscriptexpr) type.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct a [SynchronizedExpr](ast_package_classes.md#class-synchronizedexpr) type.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct a [ThisType](ast_package_classes.md#class-thistype) type.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the set [Token](ast_package_structs.md#struct-token) is not a `throw` keyword.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct a [ThrowExpr](ast_package_classes.md#class-throwexpr) type.
...
Function: A wrapper type for a sequence of [Token](ast_package_structs.md#struct-token) objects.
...
- tokArray: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Token](ast_package_structs.md#struct-token)> - An [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt) type containing [Token](ast_package_structs.md#struct-token) objects.
...
- tokArrayList: [ArrayList](../../collection/collection_package_api/collection_package_class.md#class-arraylistt)\<[Token](ast_package_structs.md#struct-token)> - An [ArrayList](../../collection/collection_package_api/collection_package_class.md#class-arraylistt) type containing [Token](ast_package_structs.md#struct-token) objects.
...
Function: Retrieves an iterator object for the [Tokens](ast_package_classes.md#class-tokens) object.
...
- r: [Token](ast_package_structs.md#struct-token) - The other [Token](ast_package_structs.md#struct-token) object to be concatenated.
...
- r: [Tokens](ast_package_classes.md#class-tokens) - The other [Tokens](ast_package_classes.md#class-tokens) object to be concatenated.
...
Function: Operator overload to retrieve the corresponding [Token](ast_package_structs.md#struct-token) via index value.
...
Function: Operator overload to retrieve the corresponding [Tokens](ast_package_classes.md#class-tokens) slice via `range`.
...
Function: Retrieves the current iterator instance.

Return Value:

- [Iterator](../../core/core_package_api/core_package_classes.md#class-iteratort)\<[Token](ast_package_structs.md#struct-token)> - The current iterator instance.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Thrown when the input [Tokens](ast_package_classes.md#class-tokens) cannot be constructed into a [TrailingClosureExpr](ast_package_classes.md#class-trailingclosureexpr) node.
...
A `try` expression consists of three parts: the `try` block, `catch` block, and `finally` block.
...
Function: Gets or sets the Catch blocks within [TryExpr](ast_package_classes.md#class-tryexpr).
...
Function: Gets or sets the `Finally` block within [TryExpr](ast_package_classes.md#class-tryexpr).
...
Function: Gets or sets the instantiated object sequence for Try-with-resources type expressions in [TryExpr](ast_package_classes.md#class-tryexpr).
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [TupleLiteral](ast_package_classes.md#class-tupleliteral) type.
...
Function: Gets or sets the sequence of "," lexical units in [TuplePattern](ast_package_classes.md#class-tuplepattern) node, which may be empty.
...
Function: Gets or sets the "(" lexical unit in [TuplePattern](ast_package_classes.md#class-tuplepattern) node.
...
Function: Gets or sets a group of [Pattern](ast_package_classes.md#class-pattern) nodes in [TuplePattern](ast_package_classes.md#class-tuplepattern) node.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [TuplePattern](ast_package_classes.md#class-tuplepattern) type.
...
Function: Gets or sets the "(" lexical unit in [TupleType](ast_package_classes.md#class-tupletype) node.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [TupleType](ast_package_classes.md#class-tupletype) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed as a [TupleType](ast_package_classes.md#class-tupletype) node.
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [TypeAliasDecl](ast_package_classes.md#class-typealiasdecl) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed as a [TypeAliasDecl](ast_package_classes.md#class-typealiasdecl) node.
...
Used to implement conversions between various numeric types. A [TypeConvExpr](ast_package_classes.md#class-typeconvexpr) node: `Int8(32)`.
...
Function: Gets or sets the original expression for type conversion in [TypeConvExpr](ast_package_classes.md#class-typeconvexpr).
...
Function: Gets or sets the target type to convert to in [TypeConvExpr](ast_package_classes.md#class-typeconvexpr).
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical unit collection ([Tokens](ast_package_classes.md#class-tokens)) to construct the [TypeConvExpr](ast_package_classes.md#class-typeconvexpr) type.
...
Function: Gets or sets the operator ":" in the [TypeNode](ast_package_classes.md#class-typenode) node, which may be a lexical unit of [ILLEGAL](ast_package_enums.md#illegal).
...
Exceptions:- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed into a [TypePattern](ast_package_classes.md#class-typepattern) node.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed into a [UnaryExpr](ast_package_classes.md#class-unaryexpr) node.
...
Function: Represents an instance node of `VArray`.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed into a [VArrayExpr](ast_package_classes.md#class-varrayexpr) node.
...
Uses the generic type `VArray<T, size: Int64>` to represent the `VArray` type.
...
Function: Gets or sets the lexical unit of the operator `$` in the [VArrayType](ast_package_classes.md#class-varraytype) node.
...
Function: Gets or sets the type argument node in the [VArrayType](ast_package_classes.md#class-varraytype), such as [Int16](../../core/core_package_api/core_package_intrinsics.md#int16) in `VArray<Int16, $0>`.
...
Function: Gets or sets the lexical unit of the keyword `VArray` in the [VArrayType](ast_package_classes.md#class-varraytype) node.
...
Function: Gets or sets the lexical unit of the left angle bracket in the [VArrayType](ast_package_classes.md#class-varraytype) node.
...
Function: Gets or sets the lexical unit of the right angle bracket in the [VArrayType](ast_package_classes.md#class-varraytype) node.
...
Function: Gets or sets the lexical unit of the type length in the [VArrayType](ast_package_classes.md#class-varraytype) node.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed into a [VArrayType](ast_package_classes.md#class-varraytype) node.
...
> **Note:**
>
> Variable declaration mainly includes the following parts: modifiers, keywords, patternsMaybeIrrefutable, variable type, and variable initial value.
...
Function: Gets or sets the colon position information in the [VarDecl](ast_package_classes.md#class-vardecl) node.

Type: [Token](ast_package_structs.md#struct-token)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Throws when the set [Token](ast_package_structs.md#struct-token) is not a colon.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws when the [VarDecl](ast_package_classes.md#class-vardecl) node has no declared variable type.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws when the [VarDecl](ast_package_classes.md#class-vardecl) node has no variable initialization.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws when the [VarDecl](ast_package_classes.md#class-vardecl) node has no declared pattern node.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed as a [VarDecl](ast_package_classes.md#class-vardecl) node.
...
Function: Determines whether it is a `Const` type node.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed as a [VarOrEnumPattern](ast_package_classes.md#class-varorenumpattern) node.
...
- identifier: [Token](ast_package_structs.md#struct-token) - The lexical unit to construct the [VarPattern](ast_package_classes.md#class-varpattern) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Throws when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed as a [VarPattern](ast_package_classes.md#class-varpattern) node.
...
> **Note:**
>
> - The `visit` functions are used in conjunction with `traverse` to enable node access and modification. All `visit` functions have empty default implementations and can be implemented as needed.
...
Function: Used in overriding `visit` functions to terminate further traversal of child nodes by calling this function.
...
`while` is a keyword, followed by parentheses containing either an expression or a `let` declaration destructuring match, then a [Block](ast_package_classes.md#class-block) node.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws when the set [Token](ast_package_structs.md#struct-token) is not the `while` keyword.
...
Function: Gets or sets the "(" after the `while` keyword in [WhileExpr](ast_package_classes.md#class-whileexpr).
...
Function: Constructs a default [WhileExpr](ast_package_classes.md#class-whileexpr) object.### init(Tokens)
...
- inputs: [Tokens](ast_package_classes.md#class-tokens) - The lexical token collection ([Tokens](ast_package_classes.md#class-tokens)) to construct a [WhileExpr](ast_package_classes.md#class-whileexpr) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed as a [WhileExpr](ast_package_classes.md#class-whileexpr) node.
...
- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the set [Token](ast_package_structs.md#struct-token) is not the "_" keyword.
...
- keyword: [Tokens](ast_package_classes.md#class-tokens) - The lexical token collection ([Tokens](ast_package_classes.md#class-tokens)) to construct a [WildcardExpr](ast_package_classes.md#class-wildcardexpr) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed as a [WildcardExpr](ast_package_classes.md#class-wildcardexpr) node.
...
Denoted by an underscore "_", which can match any value.
...
Function: Gets or sets the lexical token of the "_" operator in the [WildcardPattern](ast_package_classes.md#class-wildcardpattern) node.

Type: [Token](ast_package_structs.md#struct-token)

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the set [Token](ast_package_structs.md#struct-token) is not the "_" operator.
...
- keyword: [Tokens](ast_package_classes.md#class-tokens) - The lexical token collection ([Tokens](ast_package_classes.md#class-tokens)) to construct a [WildcardPattern](ast_package_classes.md#class-wildcardpattern) type.

Exceptions:

- [ASTException](ast_package_exceptions.md#class-astexception) - Throws an exception when the input [Tokens](ast_package_classes.md#class-tokens) type cannot be constructed as a [WildcardPattern](ast_package_classes.md#class-wildcardpattern) node.