...
Function: Negation operation, overloading the unary minus operator to negate the current [Decimal](math_numeric_package_structs.md#struct-decimal) object, returning the result while preserving the actual precision.
Return Value:
