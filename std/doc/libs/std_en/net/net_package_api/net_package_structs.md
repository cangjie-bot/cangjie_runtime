...
- name: [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - Address family name.
- value: [UInt16](../../../std/core/core_package_api/core_package_intrinsics.md#uint16) - Address family value.
...
- [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - Name of the current address family.
...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if the two [AddressFamily](net_package_structs.md#struct-addressfamily) objects are equal; otherwise, returns `false`.
...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if the two [AddressFamily](net_package_structs.md#struct-addressfamily) objects are unequal; otherwise, returns `false`.
