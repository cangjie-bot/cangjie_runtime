...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns true if it is an IPv4 address, otherwise returns false.
...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns true if it is an IPv6 address, otherwise returns false.
...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns true if it is a private address, otherwise returns false.
...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns true if it is an "unspecified" IP address, otherwise returns false.
...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if the specified [IPAddress](net_package_classes.md#class-ipaddress) address is contained; otherwise, returns `false`.
...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if the specified [IPPrefix](net_package_classes.md#class-ipprefix) address is contained; otherwise, returns `false`.
...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if there is an overlap with the specified [IPPrefix](net_package_classes.md#class-ipprefix) address; otherwise, returns `false`.
...
- port: [UInt16](../../../std/core/core_package_api/core_package_intrinsics.md#uint16) - Host-order port.
...
Function: Constructs an [IPSocketAddress](net_package_classes.md#class-ipsocketaddress) address from a string-represented IP address and a host-order [UInt16](../../../std/core/core_package_api/core_package_intrinsics.md#uint16) port.

Parameters:

- address: [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - IP address string.
- port: [UInt16](../../../std/core/core_package_api/core_package_intrinsics.md#uint16) - Host-order port.
...
Function: Constructs an [IPv4Address](net_package_classes.md#class-ipv4address) address from a host-byte-order [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) value.

Parameters:

- bits: [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) - Host-byte-order [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) value.
...
Function: Converts this [IPv4Address](net_package_classes.md#class-ipv4address) address to a host-byte-order [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) value.

Return Value:

- [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) - The host-byte-order [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) value.
...
- prefixLen: [UInt8](../../../std/core/core_package_api/core_package_intrinsics.md#uint8) - Network prefix length, must be >= 0 and <= 128.
...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns true if it is an IPv4-mapped address, otherwise false.
...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns true if it is a `Teredo` address, otherwise false.
...
public class RawSocket {
    public init(domain: SocketDomain, `type`: SocketType, protocol: ProtocolType)```markdown
...
main() {
    ...
    let udsa3_1: UnixSocketAddress = UnixSocketAddress("\u{0}/tmp/server1.sock")```markdown
