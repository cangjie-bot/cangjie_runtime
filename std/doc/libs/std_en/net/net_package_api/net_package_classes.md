...
Functionality: Converts an IP address string into an [IPAddress](net_package_classes.md#class-ipaddress) object, returning `None` if the string is invalid.

Parameters:

- s: [String](../../../std_en/core/core_package_api/core_package_structs.md#struct-string) - IP address string.
...
- [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../../std_en/core/core_package_api/core_package_types.md#type-byte)> - [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../../std_en/core/core_package_api/core_package_types.md#type-byte)> representation of the raw IP address.
...
- prefixLen: [UInt8](../../../std_en/core/core_package_api/core_package_intrinsics.md#uint8) - Network prefix length.
...
- A starting IP address (IPv4 or IPv6). This is the first IP address in the prefix.
- A prefix length. This specifies the length of the prefix by indicating the number of bits in the IP address, starting from the most significant bit in network byte order, that are constant for all addresses in the prefix.

For example, the prefix `192.0.2.0/24` covers `256` `IPv4` addresses from `192.0.2.0` to `192.0.2.255` (inclusive), and the prefix `2001:db8:1:2` covers `2^64` `IPv6` addresses from `2001:db8:1:2::` to `2001:db8:1:2:ffff:ffff:ffff:ffff` (inclusive). Objects of this class are immutable.
...
```Function: Gets the [IPAddress](net_package_classes.md#class-ipaddress) used when constructing the current [IPPrefix](net_package_classes.md#class-ipprefix) object.
...
- [Bool](../../../std_en/core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if the specified [IPAddress](net_package_classes.md#class-ipaddress) address is contained; otherwise, returns `false`.
...
- [Bool](../../../std_en/core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if the specified [IPPrefix](net_package_classes.md#class-ipprefix) address is contained; otherwise, returns `false`.
...
Function: Returns the [IPPrefix](net_package_classes.md#class-ipprefix) address after masking based on the prefix length. For example, `192.168.12.34/16` returns `192.168.0.0/16`, and `fc00::1:2:3:4/16` returns `fc00::/16`.

Return Value:

- [IPPrefix](net_package_classes.md#class-ipprefix) - The [IPPrefix](net_package_classes.md#class-ipprefix) address after masking based on the prefix length.
...
- [Bool](../../../std_en/core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if there is an overlap with the specified [IPPrefix](net_package_classes.md#class-ipprefix) address; otherwise, returns `false`.
...
- [String](../../core/core_package_api/core_package_structs.md#struct-string) - The string representation of the current [IPPrefix](net_package_classes.md#class-ipprefix), such as `192.168.0.0/16` or `fc00::/16`.
...
Function: This class implements the IP protocol Socket address (IP address + port number). It provides an immutable object for Socket binding, connection, or as a return value.
...
Function: Constructs an [IPSocketAddress](net_package_classes.md#class-ipsocketaddress) address from a string-represented IP address and a host-order [UInt16](../../../std_en/core/core_package_api/core_package_intrinsics.md#uint16) port.
...
Function: Constructs an [IPSocketAddress](net_package_classes.md#class-ipsocketaddress) address from an [IPAddress](net_package_classes.md#class-ipaddress) object and a host-order [UInt16](../../../std_en/core/core_package_api/core_package_intrinsics.md#uint16) port.

Parameters:

- address: [IPAddress](net_package_classes.md#class-ipaddress) - [IPAddress](net_package_classes.md#class-ipaddress) object.
- port: [UInt16](../../../std_en/core/core_package_api/core_package_intrinsics.md#uint16) - Host-order port.
...
- [IPSocketAddress](net_package_classes.md#class-ipsocketaddress) - [IPSocketAddress](net_package_classes.md#class-ipsocketaddress) object.
...
Function: Returns the [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../../std_en/core/core_package_api/core_package_types.md#type-byte)> representation of the raw address of this [IPSocketAddress](net_package_classes.md#class-ipsocketaddress) object, with layout consistent with `sockaddr_in` or `sockaddr_in6`.

Return Value:

- [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../../std_en/core/core_package_api/core_package_types.md#type-byte)> - [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../../std_en/core/core_package_api/core_package_types.md#type-byte)> representation of the raw address of the [IPSocketAddress](net_package_classes.md#class-ipsocketaddress) object.
...
Function: Returns the text representation string of the current [IPSocketAddress](net_package_classes.md#class-ipsocketaddress).

Return Value:

- [String](../../core/core_package_api/core_package_structs.md#struct-string) - The text representation string of the current [IPSocketAddress](net_package_classes.md#class-ipsocketaddress), such as `192.168.1.2:8080` or `[fc00::/16]:8080`.
...
Function: Returns the unspecified [IPv4Address](net_package_classes.md#class-ipv4address) address: `0.0.0.0`, which corresponds to the constant `INADDR_ANY` in other languages.
...
Function: Constructs an [IPv4Address](net_package_classes.md#class-ipv4address) address from a host-byte-order [UInt32](../../../std_en/core/core_package_api/core_package_intrinsics.md#uint32) value.

Parameters:

- bits: [UInt32](../../../std_en/core/core_package_api/core_package_intrinsics.md#uint32) - Host-byte-order [UInt32](../../../std_en/core/core_package_api/core_package_intrinsics.md#uint32) value.
...
Function: Constructs an [IPv4Address](net_package_classes.md#class-ipv4address) object from four 8-bit bytes, represented in text as `a.b.c.d`.

Parameters:

- a: [Byte](../../../std_en/core/core_package_api/core_package_types.md#type-byte) - 8-bit byte.
- b: [Byte](../../../std_en/core/core_package_api/core_package_types.md#type-byte) - 8-bit byte.
- c: [Byte](../../../std_en/core/core_package_api/core_package_types.md#type-byte) - 8-bit byte.
- d: [Byte](../../../std_en/core/core_package_api/core_package_types.md#type-byte) - 8-bit byte.
...
- [IPv4Address](net_package_classes.md#class-ipv4address) - The [IPv4Address](net_package_classes.md#class-ipv4address) object.
...
Function: Creates a network prefix object from the [IPv4Address](net_package_classes.md#class-ipv4address) based on the specified prefix length.
...
- [IPPrefix](net_package_classes.md#class-ipprefix) - The network prefix object.
...
- [Bool](../../../std_en/core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if it is a broadcast address, otherwise `false`.
...
Function: Converts this [IPv4Address](net_package_classes.md#class-ipv4address) address to a host-byte-order [UInt32](../../../std_en/core/core_package_api/core_package_intrinsics.md#uint32) value.

Return Value:

- [UInt32](../../../std_en/core/core_package_api/core_package_intrinsics.md#uint32) - The host-byte-order [UInt32](../../../std_en/core/core_package_api/core_package_intrinsics.md#uint32) value.
...
- [IPv6Address](net_package_classes.md#class-ipv4address) - The [IPv6Address](net_package_classes.md#class-ipv4address) object.
...
Function: Returns the textual representation of this [IPv4Address](net_package_classes.md#class-ipv4address).

Return Value:

- [String](../../core/core_package_api/core_package_structs.md#struct-string) - The textual representation of this [IPv4Address](net_package_classes.md#class-ipv4address), e.g., `a.b.c.d`.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if this [IPv4Address](net_package_classes.md#class-ipv4address) object is less than or equal to the compared object; otherwise, `false`.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if the two [IPv4Address](net_package_classes.md#class-ipv4address) objects are equal; otherwise, `false`.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if the two [IPv4Address](net_package_classes.md#class-ipv4address) objects are not equal; otherwise, `false`.
...
Function: Returns the `localhost` address for [IPv6Address](net_package_classes.md#class-ipv6address): `::1`.
...
Function: Returns the "unspecified" [IPv6Address](net_package_classes.md#class-ipv6address) address: `::`, which corresponds to the constant `INADDR_ANY` in other languages.
...
Function: Constructs an [IPv6Address](net_package_classes.md#class-ipv6address) from a big-endian [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)>.
...
Function: Constructs an [IPv6Address](net_package_classes.md#class-ipv6address) from eight 16-bit segments, with text representation as `a:b:c:d:e:f:g:h%scopeId`.
...
Function: Reads an [IPv6Address](net_package_classes.md#class-ipv6address) from a byte array in big-endian order.
...
- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Thrown if the buffer is too small to read an [IPv6Address](net_package_classes.md#class-ipv6address) value.

Return Value:

- [IPv6Address](net_package_classes.md#class-ipv6address) - The [IPv6Address](net_package_classes.md#class-ipv6address) object.
...
Function: Creates a network prefix object from this [IPv6Address](net_package_classes.md#class-ipv6address) based on the specified prefix length.

Parameters:

- prefixLen: [UInt8](../../../std_en/core/core_package_api/core_package_intrinsics.md#uint8) - Network prefix length, must be >= 0 and <= 128.
...
Function: Determines if this [IPv6Address](net_package_classes.md#class-ipv6address) is a global unicast address.
...
Function: Determines if this [IPv6Address](net_package_classes.md#class-ipv6address) is an IPv4-mapped address.
...
Function: Determines if this [IPv6Address](net_package_classes.md#class-ipv6address) is a link-local address.
...
Function: Determines if this [IPv6Address](net_package_classes.md#class-ipv6address) is a loopback address.
...
Function: Determines if this [IPv6Address](net_package_classes.md#class-ipv6address) is a multicast address.
...
Function: Determines if this [IPv6Address](net_package_classes.md#class-ipv6address) is a private address.
...
Function: Determines if this [IPv6Address](net_package_classes.md#class-ipv6address) is a `Teredo` address. `Teredo` prefix is `2001::/32`.
...
Function: Determines if this [IPv6Address](net_package_classes.md#class-ipv6address) is an "unspecified" IP address.
...
Function: Converts this [IPv6Address](net_package_classes.md#class-ipv6address) into a new [IPv6Address](net_package_classes.md#class-ipv6address) with the specified scope ID. If the scope ID is None, the existing scope ID is removed.
...
- [IPv6Address](net_package_classes.md#class-ipv6address) - The converted [IPv6Address](net_package_classes.md#class-ipv6address) object.
...
Function: Converts this [IPv6Address](net_package_classes.md#class-ipv6address) into an IPv4-compatible [IPv4Address](net_package_classes.md#class-ipv4address). For example, `::a.b.c.d` and `::ffff:a.b.c.d` convert to `a.b.c.d`; `::1` converts to `0.0.0.1`. All addresses not starting with all zeros or `::ffff` will return `None`.
...
Function: Converts this [IPv6Address](net_package_classes.md#class-ipv6address) into an IPv4-mapped [IPv4Address](net_package_classes.md#class-ipv4address). For example, `::ffff:a.b.c.d` converts to `a.b.c.d`. All addresses not starting with `::ffff` will return `None`.
...
Function: Writes this [IPv6Address](net_package_classes.md#class-ipv6address) into a byte array in big-endian order.

Parameters:

- buffer: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)> - Buffer to store the written data.

Exceptions:

- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Thrown if the buffer is too small to write the [IPv6Address](net_package_classes.md#class-ipv6address) value.
...
Function: Returns the string representation of this [IPv6Address](net_package_classes.md#class-ipv6address).

Return Value:

- [String](../../core/core_package_api/core_package_structs.md#struct-string) - The string representation of this [IPv6Address](net_package_classes.md#class-ipv6address), e.g., `2001:db8:1:2:ffff:ffff:ffff:ffff`.
...
Function: Determines if this [IPv6Address](net_package_classes.md#class-ipv6address) is less than or equal to the compared [IPv6Address](net_package_classes.md#class-ipv6address).

Parameters:

- rhs: [IPv6Address](net_package_classes.md#class-ipv6address) - The [IPv6Address](net_package_classes.md#class-ipv6address) to compare with.

Return Value:

- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if this [IPv6Address](net_package_classes.md#class-ipv6address) is less than or equal to the compared [IPv6Address](net_package_classes.md#class-ipv6address); otherwise, returns `false`.
...
Function: Determines if two [IPv6Address](net_package_classes.md#class-ipv6address) objects are equal.
...
Function: Determines if two [IPv6Address](net_package_classes.md#class-ipv6address) objects are not equal.
...
Functionality: [RawSocket](net_package_classes.md#class-rawsocket) provides basic socket functionalities.

It enables access to sockets with specific combinations of communication domain, type, and protocol. Since the Socket package already supports common network protocols like TCP and UDP, this type is suitable for other network programming requirements.

> **Note:**
>
> - Currently verified functionalities of [RawSocket](net_package_classes.md#class-rawsocket) include TCP, UDP, UDS, and ICMP protocol sockets. Other types may encounter unexpected issues during usage.
> - Additionally, due to the open nature of the interface, using a combination of `connect` followed by `listen` may lead to unexpected issues in certain scenarios. Developers are advised to follow standard calling logic to avoid potential problems.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when the current [RawSocket](net_package_classes.md#class-rawsocket) instance is closed or the local address cannot be retrieved.
...
- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Thrown when the read timeout value is negative.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when the current [RawSocket](net_package_classes.md#class-rawsocket) instance is closed or the peer address cannot be retrieved.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when the current [RawSocket](net_package_classes.md#class-rawsocket) instance is closed.
- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Thrown when the write timeout value is negative.
...
Functionality: Creates a socket with the specified combination of communication domain, type, and protocol.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when the specified combination of domain, type, and protocol cannot create a socket.
...
Functionality: Accepts the first pending connection request from the listening queue of the current [RawSocket](net_package_classes.md#class-rawsocket) instance and returns a new [RawSocket](net_package_classes.md#class-rawsocket) for communication.

Parameters:

- timeout!: ?[Duration](../../core/core_package_api/core_package_structs.md#struct-duration) - The maximum time to wait for a connection request. Default value `None` indicates indefinite waiting.
...
- [SocketTimeoutException](net_package_exceptions.md#class-sockettimeoutexception) - Thrown when the waiting time exceeds the specified timeout.
...
- timeout!: ?[Duration](../../core/core_package_api/core_package_structs.md#struct-duration) - The maximum time to wait for the connection to be accepted. Default value `None` indicates indefinite waiting.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when the current [RawSocket](net_package_classes.md#class-rawsocket) instance is closed or the socket option cannot be retrieved.
...
Functionality: Starts listening on the address bound to the current [RawSocket](net_package_classes.md#class-rawsocket) instance.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when the current [RawSocket](net_package_classes.md#class-rawsocket) instance is closed or the listening fails.
...
- buffer: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)> - The array to store the received data.
- flags: [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) - Flags specifying the function behavior.
...
- ([RawAddress](net_package_structs.md#struct-rawaddress), [Int64](../../core/core_package_api/core_package_intrinsics.md#int64)) - The source address of the data and the length of the received data.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when the current [RawSocket](net_package_classes.md#class-rawsocket) instance is closed or data transmission fails.
...
- addr: [RawAddress](net_package_structs.md#struct-rawaddress) - The target address for the data.
- buffer: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)> - The data to send.
- flags: [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) - Flags specifying the function behavior.

Exceptions:- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when the current [RawSocket](net_package_classes.md#class-rawsocket) instance is closed, data sending fails, or when `sendTo` is called after `connect` on macOS platform.
- [SocketTimeoutException](net_package_exceptions.md#class-sockettimeoutexception) - Throws an exception when the specified write timeout is exceeded.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when the current [RawSocket](net_package_classes.md#class-rawsocket) instance is closed or setting the socket option fails.
...
Function: A server-side socket that listens for TCP connections.

After creation, socket properties can be configured via properties and `setSocketOptionXX` interfaces.
To start listening, call `bind()` to bind the socket to a local port. The `accept()` interface accepts TCP connections, blocking until a connection is received. If connections are already queued, it returns immediately.
...
Can only be called before `bind`; otherwise, an exception is thrown.
...
Function: Sets and reads the `SO_REUSEADDR` property, which defaults to `true`.

The behavior after the property takes effect depends on the system. Before use, refer to the system documentation for `SO_REUSEADDR/SOCK_REUSEADDR`.
...
Can only be modified before binding. On Windows, `SO_REUSEADDR` can be used instead; this property is not supported, and an exception is thrown.
...
Enabling both `SO_REUSEADDR` and `SO_REUSEPORT` may cause unpredictable system errors; configure values with caution.

Type: [Bool](../../core/core_package_api/core_package_intrinsics.md#bool)

Exceptions:

- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception on Windows, as this type is not supported.
...
Function: Creates a [TcpServerSocket](net_package_classes.md#class-tcpserversocket) instance that is not yet bound, so clients cannot connect.
...
- bindAt!: [UInt16](../../core/core_package_api/core_package_intrinsics.md#uint16) - Specifies the local binding port. A value of 0 means binding to a random available local port.
...
```Function: Close the socket. The interface allows multiple calls.
...
Function: Retrieve specified socket options.

Parameters:

- level: [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) - Option level, e.g., `SOL_SOCKET`.
- option: [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) - Option name, e.g., `SO_KEEPALIVE`.
...
Function: Retrieve specified socket options. Cast from [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative). `0 => false`, non-zero => `true`.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Specified socket option. Cast from [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative). `0 => false`, non-zero => `true`.

Exceptions:

- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when `getsockopt` returns failure or option size exceeds [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative) threshold.
...
- [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative) - Retrieved socket option value.
...
Function: Check if the socket is closed.
...
Function: Set specified socket options.
...
Function: Return status information of the current [TcpServerSocket](net_package_classes.md#class-tcpserversocket).

Return Value:

- [String](../../core/core_package_api/core_package_structs.md#struct-string) - String containing status information of the current [TcpServerSocket](net_package_classes.md#class-tcpserversocket).
...
Function: TCP client for establishing connections.

After instantiation, use the `connect` function to establish a connection and explicitly execute `close` upon completion.
...
Function: Set and retrieve the bound network interface.
...
Function: Set and retrieve keep-alive properties. `None` indicates keep-alive is disabled.

Uses system default configuration if not set by the user. Setting this configuration may be delayed or ignored by the system depending on its processing capability.
...
Function: Set and retrieve the `SO_LINGER` property. Default depends on the system. `None` disables this option.

> **Note:**
>
> - If `SO_LINGER` is set to `Some(v)`, when closing the socket, if there are pending byte streams, we will wait for `v` duration before closing the connection. If the timeout is exceeded and bytes remain unsent, the connection will be terminated abnormally (closed via RST packet).
> - If `SO_LINGER` is set to `None`, when closing the socket, the connection will be closed immediately. If there are pending characters, the connection is closed using FIN-ACK; if there are remaining unsent characters, the connection is closed using RST.

Type: ?[Duration](../../core/core_package_api/core_package_structs.md#struct-duration)

Exceptions:

- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Thrown when timeout duration is less than 0.
...
Function: Retrieve the local address to which the `Socket` is or will be bound.

Type: [SocketAddress](net_package_classes.md#class-socketaddress)

Exceptions:

- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when the `Socket` is already closed or no local address is available (local address is unconfigured and socket is unconnected).
...
Function: Set and retrieve the `TCP_NODELAY` property. Default is `true`.

This option disables the Nagle algorithm, forwarding all written bytes without delay. When set to `false`, the Nagle algorithm introduces delay before packet transmission.
...
Function: Set and retrieve the `TCP_QUICKACK` property. Default is `false`.

This option is similar to `noDelay` but only affects TCP ACK and initial responses. Not supported on Windows and macOS systems.
...
Function: Set and retrieve the read operation timeout.

If the set time is too small, it will be adjusted to the minimum clock cycle value; if too large, it will be set to the maximum timeout (2<sup>63</sup>-1 nanoseconds). Default is `None`.
...
Function: Set and retrieve the `SO_RCVBUF` property, specifying the receive buffer size. Option effectiveness depends on the system.
...
Function: Sets and reads the `SO_SNDBUF` attribute, providing a way to specify the send buffer size. The actual effect depends on the system.
...
Function: Sets and reads the write operation timeout.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when the `address` parameter is invalid or when the address is all-zero on Windows.
...
- timeout!: ?[Duration](../../core/core_package_api/core_package_structs.md#struct-duration) - The connection timeout. `None` means no timeout, and the connection operation does not retry. When the server rejects the connection, it returns a connection failure. This operation includes the binding operation, so there is no need to call the `bind` interface repeatedly.

Exceptions:

- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Throws an exception when the remote address is invalid or the connection timeout is less than 0.
- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when the connection cannot be established due to system reasons (e.g., socket closed, no access rights, system error, etc.). Retrying may succeed.
- [SocketTimeoutException](net_package_exceptions.md#class-sockettimeoutexception) - Throws an exception when the connection times out.
...
- valueLength: [CPointer](../../core/core_package_api/core_package_intrinsics.md#cpointert)\<[UIntNative](../../core/core_package_api/core_package_intrinsics.md#uintnative)> - The option value length.
...
Function: Reads the specified socket option. Cast from [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative). `0 => false`, non-`0 => true`.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Whether the socket has been explicitly closed by calling `close`. Returns `true` if yes; otherwise, returns `false`.
...
Function: Reads the message. Timeout behavior is determined by `readTimeout`. See `readTimeout` for details.
...
> - On Windows, after the peer closes the connection, calling `write` once will clear the buffer content. Subsequently calling `read` will throw a connection closed exception.
> - On Linux/macOS, after the peer closes the connection, calling `write` first and then `read` will still read the content from the buffer.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when the `buffer` size is 0 or when the read fails due to system reasons.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when `setsockopt` fails.
...
Function: Sets the specified socket option.Parameters:
...
Function: Returns the current state information of [TcpSocket](net_package_classes.md#class-tcpsocket).

Return value:

- [String](../../core/core_package_api/core_package_structs.md#struct-string) - A string containing the current state information of [TcpSocket](net_package_classes.md#class-tcpsocket).
...
- payload: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)> - Buffer storing the data to be written.

Exceptions:

- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when the `buffer` size is 0 or when writing fails due to system reasons.
...
- other: [TcpSocket](net_package_classes.md#class-tcpsocket) - The [TcpSocket](net_package_classes.md#class-tcpsocket) instance to compare.
...
Function: Provides UDP message communication.

After creating an instance of `UdpSocket`, `bind()` must be called to bind it. It can receive messages without establishing a connection with a remote endpoint. `UdpSocket` can also establish a connection via the `connect()/disconnect()` interface. The UDP protocol requires that the message size must not exceed 64KB.
`UdpSocket` must be explicitly `close()`d. See [DatagramSocket](net_package_interfaces.md#interface-datagramsocket) for more information.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when the `Socket` has been closed or no local address is available (local address is not configured and the socket is not connected).
...
The default behavior and post-configuration behavior depend on the system. Before use, refer to the system documentation for this property (`SO_REUSEADDR/SOCK_REUSEADDR`).
...
The default behavior and post-configuration behavior depend on the system. Before use, refer to the system documentation for this property (`SO_REUSEPORT`).
...
Function: After a failed binding of the local port, the socket must be `close`d. Retries are not supported.
...
Function: Connects to a specific remote address. The configuration can be revoked via `disconnect`.

Only messages from this remote address will be accepted. Must be called after `bind`. After this operation, the port will start receiving ICMP messages. If an abnormal message is received, `send/sendTo` may fail.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when the port is not bound, the connection cannot be established due to system reasons, or the remote address is an all-zero address on Windows.
...
Function: Stops the connection. Cancels receiving messages only from a specific peer. Can be called before `connect` and can be called multiple times.
...
Exceptions:- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when `getsockopt` returns a failure.
...
Function: Gets the specified socket option. Cast from [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative). `0 => false`, non-zero => `true`.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when `getsockopt` returns a failure or when the parameter size exceeds the threshold of [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative).
...
Function: Receives a packet from the address connected via `connect`.

Parameters:

- buffer: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)> - The address to store the received packet.
...
Function: Receives a packet.

Parameters:

- buffer: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)> - The buffer address to store the received packet.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when the local buffer is too small to read the packet.
- [SocketTimeoutException](net_package_exceptions.md#class-sockettimeoutexception) - Throws an exception when the read operation times out.
...
Function: Sends a packet to the address connected via `connect`.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when the size of `payload` exceeds the system limit or when the system fails to send (e.g., when `connect` is called and an abnormal ICMP packet is received).
...
Function: Sends a packet. May block when there is insufficient buffer space.

Parameters:

- recipient: [SocketAddress](net_package_classes.md#class-socketaddress) - The address of the remote peer to send to.
- payload: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)> - The content of the packet to send.

Exceptions:

- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when the size of `payload` exceeds the system limit, the system fails to send (e.g., when `connect` is called and an abnormal ICMP packet is received), the remote address is all zeros on Windows, or when `sendTo` is called after `connect` on macOS.
...
After creating an instance of [UnixDatagramSocket](net_package_classes.md#class-unixdatagramsocket), the `bind()` interface should be explicitly called to bind it. Unix datagram sockets do not require connection or multiple handshakes with the remote end. However, users can still use the `connect/disconnect` interfaces to establish and terminate connections with the remote end.
Unlike UDP, UDS has no packet size limit; the limit comes from the operating system and interface implementation.
...
Function: Sets and reads the `SO_RCVBUF` property, providing a way to specify the size of the send buffer. The effectiveness of this option depends on the system.
...
```cangjie
public override mut prop soSndBuf: Int64
```
...
If the set time is too small, it will be adjusted to the minimum clock cycle value; if too large, it will be set to the maximum timeout value (2<sup>63</sup>-1 nanoseconds). The default value is `None`.
...
- bindAt!: [SocketAddress](net_package_classes.md#class-socketaddress) - The socket address to connect to. The address should not exist; it will be created during `bind`.
...
Only accepts packets from this remote address. Automatically performs `bind`, so no additional `bind` call is needed. After this operation, the port will start receiving ICMP packets. If an abnormal packet is received, it may cause `send/sendTo` to fail.
...
- option: [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) - Option, e.g., `SO_KEEPALIVE`.
- value: [CPointer](../../core/core_package_api/core_package_intrinsics.md#cpointert)\<[Unit](../../core/core_package_api/core_package_intrinsics.md#unit)> - Option value.
- valueLength: [CPointer](../../core/core_package_api/core_package_intrinsics.md#cpointert)\<UIntNative> - Length of the option value.
...
Function: Checks whether the socket has been explicitly closed via `close`.
...
- buffer: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)> - Address to store the received packets.

Return Value:

- [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) - Size of the received packet.
...
- payload: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)> - Content of the packet to send.
...
- recipient: [SocketAddress](net_package_classes.md#class-socketaddress) - The peer address to send to.
- payload: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)> - Content of the packet to send.

Exceptions:

- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when the `payload` size exceeds system limits, the system fails to send (e.g., when `connect` is called and an abnormal ICMP packet is received, sending will fail), or when `sendTo` is called after `connect` on macOS.
...
- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when `setsockopt` returns failure.- level: [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) - Level, e.g. `SOL_SOCKET`.
- option: [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) - Option, e.g. `SO_KEEPALIVE`.
- value: [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Option value.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Returns the specified socket option value. Cast from [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative). `0 => false, non-zero => true`.
...
Function: Returns the current state information of `UDS`.

Return value:

- [String](../../core/core_package_api/core_package_structs.md#struct-string) - A string containing the current state information of `UDS`.
...
Function: Provides duplex stream-based host communication server.

[UnixServerSocket](net_package_classes.md#class-unixserversocket) listens for connections. After creation, properties can be configured via attributes and `setSocketOptionXX` interfaces. The `bind()` interface must be called to bind the local address and start listening for connections. Connections can be accepted via the `accept()` interface.
...
- bindAt!: [SocketAddress](net_package_classes.md#class-socketaddress) - The socket address to connect.

### init(String)

```cangjie
public init(bbindAt!: String)
```

Function: Creates an unconnected [UnixServerSocket](net_package_classes.md#class-unixserversocket) instance.

This file type can be checked for existence via [isSock](../../posix/posix_package_api/posix_package_funcs.md#func-issockstring) and deleted via [unlink](../../posix/posix_package_api/posix_package_funcs.md#func-unlinkstring)() interface. If failed, the socket must be `close`d and does not support multiple retries.

Parameters:

- bindAt!: [String](../../core/core_package_api/core_package_structs.md#struct-string) - The file address to connect.
...
- [SocketTimeoutException](net_package_exceptions.md#class-sockettimeoutexception) - Thrown when connection times out.
- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Thrown when timeout duration is less than 0.
...
Function: Closes the socket. All operations on this socket except `close/isClosed` are no longer allowed. This interface can be called multiple times.
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Returns the specified socket option. Cast from [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative). `0 => false, non-zero => true`.
...
Function: Gets the integer-type socket option.
...
- [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative) - The specified socket option value.Exceptions:

- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when `getsockopt` returns failure or parameter size exceeds the threshold of [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative).
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` if the socket was explicitly closed by calling `close`; otherwise, returns `false`.
...
Function: Sets socket options that return integer values.
...
- localAddress!: ?[SocketAddress](net_package_classes.md#class-socketaddress) - The local socket address to bind; defaults to `None`.
...
This file type can be checked for existence using [isSock](../../posix/posix_package_api/posix_package_funcs.md#func-issockstring) and deleted using the [unlink](../../posix/posix_package_api/posix_package_funcs.md#func-unlinkstring)() method.

Parameters:

- path: [String](../../core/core_package_api/core_package_structs.md#struct-string) - The file address to connect to.
- localPath!: ?[String](../../core/core_package_api/core_package_structs.md#struct-string) - The local socket address path to bind; defaults to `None`.
...
Function: Closes the socket. All operations except `close/isClosed` are no longer allowed. The method can be called multiple times.
...
Function: Establishes a remote connection. If the peer rejects the connection, it fails. Automatically binds the local address, so no additional binding operation is required.

Parameters:

- timeout!: ?[Duration](../../core/core_package_api/core_package_structs.md#struct-duration) - The timeout duration. `None` means no timeout. Unlike TCP, Unix returns an error immediately when the queue is full, rather than retrying or blocking.

Exceptions:

- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Thrown when the remote address is invalid or the timeout is less than 0.
- [SocketException](net_package_exceptions.md#class-socketexception) - Thrown when the connection cannot be established due to system reasons.
...
Function: Gets the specified socket option. Cast from [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative). `0 => false`, non-`0 => true`.Parameters:
...
- [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) - Returns the specified socket option value. Strongly cast from [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative). `0 => false`, non-zero => `true`.

Exceptions:

- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when `getsockopt` fails or when the parameter size exceeds the threshold of [IntNative](../../core/core_package_api/core_package_intrinsics.md#intnative).
...
- buffer: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)> - Variable to store the read data.

Return Value:

- [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) - Length of the read data.

Exceptions:

- [SocketException](net_package_exceptions.md#class-socketexception) - Throws an exception when the `buffer` size is 0 or when reading fails due to system reasons.
...
- buffer: [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)> - Variable storing the data to be written.
...
Function: This class implements the Unix Domain Socket address, which encapsulates the filesystem path to which a Unix Domain Socket is bound or connected. The path length must not exceed 108.
...
Function: Constructs a [UnixSocketAddress](net_package_classes.md#class-unixsocketaddress) address from a filesystem path represented by [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../core/core_package_api/core_package_types.md#type-byte)>.
...
Function: Constructs a [UnixSocketAddress](net_package_classes.md#class-unixsocketaddress) address from a filesystem path represented by a string.
...
Function: Returns the raw IP address of this [UnixSocketAddress](net_package_classes.md#class-unixsocketaddress) object, with content layout consistent with `sockaddr_un` format.
...
Function: Returns the textual representation string of the current [UnixSocketAddress](net_package_classes.md#class-unixsocketaddress).

Return Value:

- [String](../../core/core_package_api/core_package_structs.md#struct-string) - The textual representation string of the current [UnixSocketAddress](net_package_classes.md#class-unixsocketaddress), e.g., `/tmp/socket1`.
