...
- domain: [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - The domain name.
...
- s: [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - The IP address string.
...
- prefixLen: [UInt8](../../../std/core/core_package_api/core_package_intrinsics.md#uint8) - The network prefix length.
...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns true if the specified [IPAddress](net_package_classes.md#class-ipaddress) address is contained, false otherwise.
...
- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns true if the specified [IPPrefix](net_package_classes.md#class-ipprefix) address is contained, false otherwise.
...
Return Value:- [Bool](../../../std/core/core_package_api/core_package_intrinsics.md#bool) - Returns `true` indicating overlap with the specified [IPPrefix](net_package_classes.md#class-ipprefix) address, `false` otherwise.
...
Function: Constructs an [IPSocketAddress](net_package_classes.md#class-ipsocketaddress) from a string-represented IP address and a host-order [UInt16](../../../std/core/core_package_api/core_package_intrinsics.md#uint16) port.
...
- port: [UInt16](../../../std/core/core_package_api/core_package_intrinsics.md#uint16) - A host-order port.
...
- s: [String](../../../std/core/core_package_api/core_package_structs.md#struct-string) - An IP protocol Socket string.
...
Function: Returns an [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../../std/core/core_package_api/core_package_types.md#type-byte)> representation of the raw address of this [IPSocketAddress](net_package_classes.md#class-ipsocketaddress) object, with layout consistent with `sockaddr_in` or `sockaddr_in6`.

Return Value:

- [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../../std/core/core_package_api/core_package_types.md#type-byte)> - An [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)\<[Byte](../../../std/core/core_package_api/core_package_types.md#type-byte)> representation of the raw address.
...
- bits: [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) - A native-endian [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) value.
...
- a: [Byte](../../../std/core/core_package_api/core_package_types.md#type-byte) - An 8-bit byte.
- b: [Byte](../../../std/core/core_package_api/core_package_types.md#type-byte) - An 8-bit byte.
- c: [Byte](../../../std/core/core_package_api/core_package_types.md#type-byte) - An 8-bit byte.
- d: [Byte](../../../std/core/core_package_api/core_package_types.md#type-byte) - An 8-bit byte.
...
Function: Converts this [IPv4Address](net_package_classes.md#class-ipv4address) address to a [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) value in host byte order.

Return Value:

- [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) - [UInt32](../../../std/core/core_package_api/core_package_intrinsics.md#uint32) value in host byte order.
...
- prefixLen: [UInt8](../../../std/core/core_package_api/core_package_intrinsics.md#uint8) - The network prefix length, must be >= 0 and <= 128.
