...
- [IllegalArgumentException](../../../std/core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Thrown when [ArgumentSpec](./argopt_package_enums.md#enum-argumentspec) with duplicate `name` is defined.