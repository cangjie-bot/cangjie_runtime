...
main(): Unit {
    ...
    } catch (e: IllegalArgumentException) {```markdown
        println("Error: ${e.message}")
    }
}
```
...
main(): Unit {
    ...
    bufferedStream.read(buffer)```markdown
...
main(): Unit {
    ...
    try {
        buffer.reserve(Int64.Max - buffer.capacity + 1)```markdown
...
- ?[Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) - If the read is successful, returns [Option](../../core/core_package_api/core_package_enums.md#enum-optiont)\<[Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune)>.Some(c), where c is the character read; otherwise, returns [Option](../../core/core_package_api/core_package_enums.md#enum-optiont)\<[Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune)>.None.
...
- predicate: ([Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune))->Bool - An expression that returns `true` when a certain condition is met.
...
- v: [Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) - The specified character.
...
Function: Obtains a [Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) iterator for the [StringReader](io_package_classes.md#class-stringreadert-where-t--inputstream).

Return Value:

- [Iterator](../../core/core_package_api/core_package_classes.md#class-iteratort)\<[Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune)> - A [Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) iterator for the string.
...
Function: Writes a [Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) type.

Parameters:

- v: [Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) - An instance of [Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) type.
...
Function: Writes a [Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) type + newline character.

Parameters:- v: [Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) - An instance of the [Rune](../../../std/core/core_package_api/core_package_intrinsics.md#rune) type.
