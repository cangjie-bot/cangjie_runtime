...
Functionality: This interface defines a formatting function that converts an instance of a specified type into a corresponding formatted string based on formatting parameters.

For details about formatting parameters, please refer to the [Functionality Introduction](./../convert_package_overview.md#function-overview) in the convert package.

Other types can provide formatting capabilities by implementing this interface.
...
Functionality: Formats the current instance into a corresponding formatted string based on formatting parameters.
...
Functionality: Extends the [Formattable](convert_package_interfaces.md#interface-formattable) interface for [Float16](../../core/core_package_api/core_package_intrinsics.md#float16) to enable converting [Float16](../../core/core_package_api/core_package_intrinsics.md#float16) instances into formatted strings.
...
Functionality: Formats the current [Float16](../../core/core_package_api/core_package_intrinsics.md#float16) type instance into a corresponding formatted string based on formatting parameters.
...
Functionality: Extends the [Formattable](convert_package_interfaces.md#interface-formattable) interface for [Float32](../../core/core_package_api/core_package_intrinsics.md#float32) to enable converting [Float32](../../core/core_package_api/core_package_intrinsics.md#float32) instances into formatted strings.
...
Functionality: Formats the current [Float32](../../core/core_package_api/core_package_intrinsics.md#float32) type instance into a corresponding formatted string based on formatting parameters.
...
Functionality: Extends the [Formattable](convert_package_interfaces.md#interface-formattable) interface for [Float64](../../core/core_package_api/core_package_intrinsics.md#float64) to enable converting [Float64](../../core/core_package_api/core_package_intrinsics.md#float64) instances into formatted strings.
...
Functionality: Formats the current [Float64](../../core/core_package_api/core_package_intrinsics.md#float64) type instance into a corresponding formatted string based on formatting parameters.
...
Functionality: Extends the [Formattable](convert_package_interfaces.md#interface-formattable) interface for [Int16](../../core/core_package_api/core_package_intrinsics.md#int16) to enable converting [Int16](../../core/core_package_api/core_package_intrinsics.md#int16) instances into formatted strings.
...
Functionality: Formats the current [Int16](../../core/core_package_api/core_package_intrinsics.md#int16) type instance into a corresponding formatted string based on formatting parameters.

Parameters:- fmt: [String](../../core/core_package_api/core_package_structs.md#struct-string) - Formatting parameters.
...
Functionality: Extends the [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) type with the [Formattable](convert_package_interfaces.md#interface-formattable) interface to enable formatted string conversion of [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) instances.
...
Functionality: Formats the current [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) instance into a string according to the specified format parameters.
...
Functionality: Extends the [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) type with the [Formattable](convert_package_interfaces.md#interface-formattable) interface to enable formatted string conversion of [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) instances.
...
Functionality: Formats the current [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) instance into a string according to the specified format parameters.
...
Functionality: Extends the [Int8](../../core/core_package_api/core_package_intrinsics.md#int8) type with the [Formattable](convert_package_interfaces.md#interface-formattable) interface to enable formatted string conversion of [Int8](../../core/core_package_api/core_package_intrinsics.md#int8) instances.
...
Functionality: Formats the current [Int8](../../core/core_package_api/core_package_intrinsics.md#int8) instance into a string according to the specified format parameters.
...
Functionality: Extends the [Rune](../../core/core_package_api/core_package_intrinsics.md#rune) type with the [Formattable](convert_package_interfaces.md#interface-formattable) interface to enable formatted string conversion of [Rune](../../core/core_package_api/core_package_intrinsics.md#rune) instances.
...
Functionality: Formats the current [Rune](../../core/core_package_api/core_package_intrinsics.md#rune) instance into a string according to the specified format parameters.
...
Functionality: Extends the [UInt16](../../core/core_package_api/core_package_intrinsics.md#uint16) type with the [Formattable](convert_package_interfaces.md#interface-formattable) interface to enable formatted string conversion of [UInt16](../../core/core_package_api/core_package_intrinsics.md#uint16) instances.

Parent Type:

- [Formattable](#interface-formattable)#### func format(String)
...
Function: Extends the [Formattable](convert_package_interfaces.md#interface-formattable) interface for [UInt32](../../core/core_package_api/core_package_intrinsics.md#uint32) to enable converting [UInt32](../../core/core_package_api/core_package_intrinsics.md#uint32) instances into formatted strings.
...
Function: Extends the [Formattable](convert_package_interfaces.md#interface-formattable) interface for [UInt64](../../core/core_package_api/core_package_intrinsics.md#uint64) to enable converting [UInt64](../../core/core_package_api/core_package_intrinsics.md#uint64) instances into formatted strings.
...
Function: Extends the [Formattable](convert_package_interfaces.md#interface-formattable) interface for [UInt8](../../core/core_package_api/core_package_intrinsics.md#uint8) to enable converting [UInt8](../../core/core_package_api/core_package_intrinsics.md#uint8) instances into formatted strings.
...
Function: This extension primarily implements operations for converting string literals of [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) type to [Bool](../../core/core_package_api/core_package_intrinsics.md#bool) values.
...
Function: This extension primarily implements operations for converting string literals of [Float16](../../core/core_package_api/core_package_intrinsics.md#float16) type to [Float16](../../core/core_package_api/core_package_intrinsics.md#float16) values.

> **Note:**
>
> Currently, binary and octal floating-point number conversions are not supported.
...
- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Throws an exception when the string does not conform to floating-point number syntax.
...
Function: This extension primarily implements operations for converting string literals of [Float32](../../core/core_package_api/core_package_intrinsics.md#float32) type to [Float32](../../core/core_package_api/core_package_intrinsics.md#float32) values.
...
- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Throws an exception when the string is empty, starts with `+`, conversion fails, the converted value exceeds the [Int16](../../core/core_package_api/core_package_intrinsics.md#int16) range, or the string contains invalid UTF-8 characters.
...
- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Throws an exception when the string is empty, starts with `+`, conversion fails, the converted value exceeds the [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) range, or the string contains invalid UTF-8 characters.
...
Function: This extension primarily implements operations to convert string literals of type [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) to [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) values.
...
Function: This extension primarily implements operations to convert string literals of type [Int8](../../core/core_package_api/core_package_intrinsics.md#int8) to [Int8](../../core/core_package_api/core_package_intrinsics.md#int8) values.
...
Function: This extension primarily implements operations to convert string literals of type [Rune](../../core/core_package_api/core_package_intrinsics.md#rune) to [Rune](../../core/core_package_api/core_package_intrinsics.md#rune) values.
...
Function: Converts a string literal of type [Rune](../../core/core_package_api/core_package_intrinsics.md#rune) to a [Rune](../../core/core_package_api/core_package_intrinsics.md#rune) value.
...
The radix is specified via parameters, not by string prefixes. The radix must be within the range of 2-36; otherwise, an exception will be thrown. For radixes beyond decimal, uppercase or lowercase English letters are used in alphabetical order (i.e., 10 digits + 26 English letters = 36 radix). Strings for Int series can start with `+` or `-`; if they don't, they are treated as `+`. Strings for UInt series can start with `+`; if they start with `-`, an exception will be thrown. Returns a string in the specified radix format. For radixes beyond decimal, lowercase English letters are used in alphabetical order (i.e., 10 digits + 26 lowercase English letters = 36 radix).

This interface provides two sets of methods: parse and tryParse. The parse method throws an exception upon parsing failure, while the tryParse method wraps the return value in [Option](../../core/core_package_api/core_package_enums.md#enum-optiont) and returns None upon failure.
This package already implements this interface for basic types such as [Int64](../../core/core_package_api/core_package_intrinsics.md#int64) and [UInt64](../../core/core_package_api/core_package_intrinsics.md#uint64), which can be used to convert strings into these types.
...
Functionality: Parses a specific type from a string of the specified radix.
...
- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Throws an exception when the string is empty, the radix is out of range, the converted value exceeds the [Int8](../../core/core_package_api/core_package_intrinsics.md#int8) range, the string contains invalid UTF-8 characters, or the conversion fails.#### static func tryParse(String, Int64)
...
- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Thrown when the string is empty, the radix is out of range, the converted value exceeds the [Int16](../../core/core_package_api/core_package_intrinsics.md#int16) range, the string contains invalid UTF-8 characters, or the conversion fails.
...
- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Thrown when the string is empty, the radix is out of range, the converted value exceeds the [Int32](../../core/core_package_api/core_package_intrinsics.md#int32) range, the string contains invalid UTF-8 characters, or the conversion fails.
...
- [IllegalArgumentException](../../core/core_package_api/core_package_exceptions.md#class-illegalargumentexception) - Thrown when the string is empty, radix is out of range, first character is `-`, converted value exceeds [UInt64](../../core/core_package_api/core_package_intrinsics.md#uint64) range, or the string contains invalid UTF-8 characters.
