...
```cangjie
extend<T> Array<T> <: PrettyPrinter
```

功能：对 [Array](../../core/core_package_api/core_package_structs.md#struct-arrayt)<T> 扩展实现 [PrettyPrinter](#interface-prettyprintable)。
...
```cangjie
extend<T> ArrayList<T> <: PrettyPrinter
```

功能：对 [ArrayList](../../collection/collection_package_api/collection_package_class.md#class-arraylistt)<T> 扩展实现 [PrettyPrinter](#interface-prettyprintable)。
