...
```cangjie
extend Float16 <: AssertPrintable
```
...
```cangjie
extend Float32 <: AssertPrintable
```
...
```cangjie
extend Float64 <: AssertPrintable
```
...
```cangjie
extend<T> Option<T> <: AssertPrintable
```
